...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gPCzh", function() { return gPCzh; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace gPCzh.
 * @public
 */

goog.module('gPCzh.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2614 = function() {
    ...
    ie_open('p');
      itext('With all the different functions out there in the real world, sometimes it is nice to restrict them to a specific -arity to work with your all your wonderful compositions. When you want to restrict any function of any arity to a simple binary function. Just pass your function to ');
      ie_open('code');
        itext('binary');
      ie_close('code');
    ...
    ie_close('p');
    $templateAlias2({code: 'import composeK from \'crocks/helpers/composeK\'\n\nimport getProp from \'crocks/Maybe/getProp\'\nimport isObject from \'crocks/predicates/isObject\'\nimport safe from \'crocks/Maybe/safe\'\n\nconst data = {\n  do: {\n    re: {\n      mi: \'fa\'\n    }\n  }\n}\n\n// flow :: a -> Maybe b\nconst flow = composeK(\n  getProp(\'mi\'),\n  getProp(\'re\'),\n  getProp(\'do\'),\n  safe(isObject)\n)\n\nflow(data)\n//=> Just \'fa\'', mode: 'javascript'}, null, opt_ijData);
    ie_open('p');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('then');
      ie_close('code');
      itext(' function. Doing this involves a lot of boilerplate and forces you into a fluent style, whether you want to be or not. Using ');
      ie_open('code');
        itext('composeP');
      ie_close('code');
      ...
      ie_open('code');
        itext('Promise');
      ie_close('code');
      itext(' returning functions like you would any other function composition, in a right-to-left fashion.');
    ie_close('p');
    ie_open('p');
    ...
    ie_open('p');
      ie_open('code');
        itext('crocks/helpers/getPathOr');
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'getPathOr :: a -> [ (String | Integer) ] -> b -> c', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('While ');
      ie_open('a', null, null,
          'href', '#getpropor');
      ...
      ie_open('code');
        itext('getPathOr');
      ie_close('code');
      itext(', which was previously called ');
      ie_open('code');
        itext('propPathOr');
      ie_close('code');
    ...
    ie_close('p');
    $templateAlias2({code: 'import getPathOr from \'crocks/helpers/getPathOr\'\n\nconst data = {\n  foo: {\n    bar: \'bar\',\n    null: null,\n    nan: NaN,\n    undef: undefined\n  },\n  arr: [ 1, 2 ]\n}\n\n// def :: [ String | Integer ] -> a -> b\nconst def =\n  getPathOr(\'default\')\n\ndef([ \'foo\', \'bar\' ], data)\n//=> "bar"\n\ndef([ \'baz\', \'tommy\' ], data)\n//=> "default"\n\ndef([ \'foo\', \'null\' ], data)\n//=> null\n\ndef([ \'foo\', \'nan\' ], data)\n//=> NaN\n\ndef([ \'foo\', \'undef\' ], data)\n//=> "default"\n\ndef([ \'arr\', \'length\' ], data)\n//=> 2', mode: 'javascript'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'getpropor',
          'href', '#getpropor');
    ...
    ie_open('p');
      ie_open('code');
        itext('crocks/helpers/getPropOr');
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'getPropOr :: a -> (String | Integer) -> b -> a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('Reach for ');
      ie_open('code');
        itext('getPropOr');
      ie_close('code');
      itext(', previously known as ');
      ie_open('code');
        itext('propOr');
      ie_close('code');
      itext(', when you want some safety around pulling a value out of an Object or Array with a single key or index. Well, as long as you are working with non-nested data that is. Just tell ');
      ie_open('code');
        itext('getPropOr');
      ie_close('code');
    ...
    ie_close('p');
    $templateAlias2({code: 'import getPropOr from \'crocks/helpers/getPropOr\'\n\nconst data = {\n  foo: \'bar\',\n  null: null,\n  nan: NaN,\n  undef: undefined\n}\n\n// def :: (String | Integer) -> a -> b\nconst def =\n  getPropOr(\'default\')\n\ndef(\'foo\', data)\n//=> "bar"\n\ndef(\'null\', data)\n//=> null\n\ndef(\'nan\', data)\n//=> NaN\n\ndef(\'baz\', data)\n//=> "default"\n\ndef(\'undef\', data)\n//=> "default"', mode: 'javascript'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'lifta2',
          'href', '#lifta2');
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'omit :: [ String ] -> Object -> Object', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
    ...
    ie_close('p');
    $templateAlias2({code: 'import partial from \'crocks/helpers/partial\'\n\nimport map from \'crocks/pointfree/map\'\n\n// max10 :: Number -> Number\nconst max10 =\n  partial(Math.min, 10)\n\n// data :: [ Number ]\nconst data =\n  [ 13, 5, 13 ]\n\nmap(max10, data)\n//=> [ 10, 5, 10]', mode: 'javascript'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'pick',
          'href', '#pick');
    ...
    ie_open('p');
      ie_open('code');
        itext('crocks/helpers/setPath');
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'setPath :: [ (String | Integer) ] -> a -> (Object | Array) -> (Object | Array)', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('Used to set a value on a deeply nested ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(', ');
      ie_open('code');
        itext('setPath');
      ie_close('code');
      itext(' will traverse down a path and set the a the final property to the provided value. ');
      ie_open('code');
        itext('setPath');
      ie_close('code');
      itext(' returns the an ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext('/');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(' with the modification and does not alter the original');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext('/');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(' along the path.');
    ie_close('p');
    ie_open('p');
      itext('The provided path can be a mixture of either ');
      ie_open('code');
        itext('Integer');
      ie_close('code');
      itext('s or ');
      ie_open('code');
        itext('String');
      ie_close('code');
      itext('s to allow for traversing through both ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext('s and ');
      ...
      ie_open('code');
        itext('Integer');
      ie_close('code');
      itext(' zero or greater is provided it will treat that portion as an ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(' while ');
      ie_open('code');
        itext('String');
      ie_close('code');
      itext('s are used to reference through ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext('s. If at any point in the provided a ');
      ie_open('code');
        itext('NaN');
      ie_close('code');
      itext(', ');
      ...
      ie_open('code');
        itext('null');
      ie_close('code');
      itext(' values is encountered, a new ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext('/');
    ...
    ie_open('p');
      ie_open('code');
        itext('crocks/helpers/setProp');
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'setProp ::  (String | Integer) -> a -> (Object | Array) -> (Object | Array)', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('Used to set a given value for a specific key or index of an ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(' or ');
      ...
      ie_open('code');
        itext('setProp');
      ie_close('code');
      itext(', previously called ');
      ie_open('code');
        itext('assoc');
      ie_close('code');
      itext(', takes either a ');
      ie_open('code');
        itext('String');
      ie_close('code');
      itext(' or ');
      ie_open('code');
        itext('Integer');
      ie_close('code');
      itext(' value as its first argument and a value of any type as its second. The third parameter is dependent of the type of the first argument. When a ');
      ie_open('code');
        itext('String');
      ie_close('code');
      itext(' is provided, the third argument must be an ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext('. Otherwise if the first argument is an ');
      ie_open('code');
        itext('Integer');
      ie_close('code');
      itext(' zero or greater, then the third must be an ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext('.');
    ...
    ie_open('p');
      ie_open('code');
        itext('setProp');
      ie_close('code');
      itext(' will return a new instance of either ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(' or ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(' with the addition applied. When the value exists on the provided object, then the value will overwritten. If the value does not exist then it will be added to the resulting structure. In the case of ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(', the value will be added to the provided index, leaving ');
      ie_open('code');
        itext('undefined');
      ie_close('code');
      itext(' values, resulting in a sparse ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext('.');
    ie_close('p');
    $templateAlias2({code: 'import setProp from \'crocks/helpers/setProp\'\n\nsetProp(\'a\', false, { a: true })\n//=> { a: false }\n\nsetProp(\'b\', 43, { a: true })\n//=> { a: true, b: 43 }\n\nsetProp(0, \'string\', [ \'a\' ])\n//=> [ "string" ]\n\nsetProp(1, \'b\', [ \'a\' ])\n//=> [ "a", "b" ]\n\nsetProp(2, \'c\', [ \'a\' ])\n//=> [ "a", undefined, "c" ]', mode: 'javascript'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'tap',
          'href', '#tap');
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'tryCatch :: ((*) -> b) -> (*) -> Result e b', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
    ...
    ie_open('p');
      ie_open('code');
        itext('crocks/helpers/unsetPath');
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'unsetPath :: [ (String | Integer) ] -> a -> a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('Used to remove a property or index on a deeply nested ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext('/');
      ...
      ie_open('code');
        itext('dissoc');
      ie_close('code');
      itext(', will return a new instance with the property or index removed.');
    ie_close('p');
    ie_open('p');
      itext('The provided path can be a mixture of either Positive ');
      ie_open('code');
        itext('Integer');
      ie_close('code');
      itext('s or ');
      ...
      ie_open('code');
        itext('Integer');
      ie_close('code');
      itext(' is provided it will treat that portion as an ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(' while ');
    ...
    ie_open('p');
      ie_open('code');
        itext('crocks/helpers/unsetProp');
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'unsetProp :: (String | Integer) -> a -> a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      ie_open('code');
        itext('unsetProp');
      ie_close('code');
      itext(' is a binary function that takes either a property name or an index as its first argument. Which specifies what should be removed, or "unset", from the ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(' or ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(' provided as the second argument. If the value provided for the second argument is not an ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(' or ');
      ie_open('code');
        itext('Array');
      ie_close('code');
      itext(', then the value provided is echoed back as the result.');
    ie_close('p');
    ie_open('p');
      itext('The first argument must be either a non-empty ');
      ie_open('code');
        itext('String');
      ie_close('code');
      itext(' or positive ');
      ...
      ie_open('code');
        itext('String');
      ie_close('code');
      itext(' should be provided when working with an ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(', while ');
      ...
      ie_open('code');
        itext('unsetProp');
      ie_close('code');
      itext(' will return a new instance of either the ');
      ie_open('code');
        itext('Object');
      ie_close('code');
      itext(' or ');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'gPCzh.render';
}
...
class gPCzh extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(gPCzh, templates);
...
var _helpersSoy = __webpack_require__(233);
...
var gPCzh = function (_Component) {
  _inherits(gPCzh, _Component);

  function gPCzh() {
    _classCallCheck(this, gPCzh);

    return _possibleConstructorReturn(this, (gPCzh.__proto__ || Object.getPrototypeOf(gPCzh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gPCzh, _helpersSoy2.default);

exports.default = gPCzh;
