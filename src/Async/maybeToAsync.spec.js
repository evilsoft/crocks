...
test('maybeToAsync transform', t => {
  ...
  const err = /maybeToAsync: Second argument must be a Maybe or a Function that returns a Maybe/
...
test('maybeToAsync with Maybe returning function', t => {
  ...
  const err = /maybeToAsync: Second argument must be a Function that returns a Maybe/
