...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BvFLd", function() { return BvFLd; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace BvFLd.
 * @public
 */

goog.module('BvFLd.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1331 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> ((c -> Either d b), (a -> Either d b)) -> Either d b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Combining a sequential series of transformations that capture disjunction can be accomplished with ');
        ie_open('a', null, null,
            'href', '#chain');
        ...
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' returning functions as its arguments. When invoked on a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('code');
          itext('bichain');
        ie_close('code');
        itext(' will use the left, or first, function that can return either a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instance. When called on a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1331}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'BvFLd.render';
}
...
class BvFLd extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(BvFLd, templates);
...
var BvFLd = function (_Component) {
  _inherits(BvFLd, _Component);

  function BvFLd() {
    _classCallCheck(this, BvFLd);

    return _possibleConstructorReturn(this, (BvFLd.__proto__ || Object.getPrototypeOf(BvFLd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BvFLd, _EitherSoy2.default);

exports.default = BvFLd;
