...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nMgqE", function() { return nMgqE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace nMgqE.
 * @public
 */

goog.module('nMgqE.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1909 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'ReaderT :: MonadTypeRep M, Monad m => M -> Reader(M) e (m a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('ReaderT');
        ie_close('code');
        itext(' is a type constructor that defines a unary function that takes a constructor, or TypeRep, of any ');
        ie_open('code');
          itext('Monad');
        ie_close('code');
        itext(' and returns a new constructor that can be used to construct ');
        ie_open('code');
          itext('Reader');
        ie_close('code');
        itext(' instances that fix the far right portion of the ');
        ie_open('code');
          itext('Reader(M)');
        ie_close('code');
        itext(' to the provided ');
        ie_open('code');
          itext('Monad');
        ie_close('code');
        itext('.');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1909}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'nMgqE.render';
}
...
class nMgqE extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(nMgqE, templates);
...
var _ReaderTSoy = __webpack_require__(227);
...
var nMgqE = function (_Component) {
  _inherits(nMgqE, _Component);

  function nMgqE() {
    _classCallCheck(this, nMgqE);

    return _possibleConstructorReturn(this, (nMgqE.__proto__ || Object.getPrototypeOf(nMgqE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nMgqE, _ReaderTSoy2.default);

exports.default = nMgqE;
