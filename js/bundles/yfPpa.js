...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "yfPpa", function() { return yfPpa; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace yfPpa.
 * @public
 */

goog.module('yfPpa.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3073 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('Boolean');
      ie_close('code');
      itext(' values, mapping truthy values to ');
      ie_open('code');
        itext('true');
      ie_close('code');
      itext(' and falsy values to ');
      ie_open('code');
        itext('false');
      ie_close('code');
      itext('.');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3073}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'yfPpa.render';
}
...
class yfPpa extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(yfPpa, templates);
...
var yfPpa = function (_Component) {
  _inherits(yfPpa, _Component);

  function yfPpa() {
    _classCallCheck(this, yfPpa);

    return _possibleConstructorReturn(this, (yfPpa.__proto__ || Object.getPrototypeOf(yfPpa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yfPpa, _AllSoy2.default);

exports.default = yfPpa;
