...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CFbkT", function() { return CFbkT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace CFbkT.
 * @public
 */

goog.module('CFbkT.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1109 = function() {
    $templateAlias2({code: 'Identity a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      ie_open('code');
        itext('Identity');
      ie_close('code');
      ...
      ie_open('code');
        itext('crock');
      ie_close('code');
      itext(' that can be used to wrap a common interface around existing Javascript types and functions. It maintains integrity by lifting and applying functions and types as is, without adding any additional structure or effects. By not applying and additional structure to existing functions,');
      ie_open('code');
        itext('Identity');
      ie_close('code');
      itext(' can be swapped in and out for other ');
      ie_open('code');
        itext('Functor');
      ie_close('code');
      itext('s that do apply their own structure and effects.');
    ie_close('p');
    $templateAlias2({code: 'import Identity from \'crocks/Identity\'\n\nIdentity(10)\n//=> Identity 10', mode: 'javascript'}, null, opt_ijData);
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Identity :: a -> Identity a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('The contstructor for an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' is a unary function. When a value is passed in an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' of the given value is returned ready for ');
        ie_open('code');
          itext('map');
        ie_close('code');
        itext(' or ');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Identity.of :: a -> Identity a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('of');
        ie_close('code');
        itext(' is used to construct an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' with any given value. It is there to allow ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' to work as a pointed functor.');
      ie_close('p');
      $templateAlias2({code: 'import Identity from \'crocks/Identity\'\n\nIdentity.of(42)\n//=> Identity 42\n\nIdentity.of(true)\n//=> Identity true', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'topic-instance');
      ie_open('h2');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Identity a ~> b -> Boolean', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('true');
        ie_close('code');
        itext(' if the passed arguments is an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Identity s => Identity s ~> Identity s -> Identity s', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Identity a ~> (a -> b) -> Identity b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to apply transformations to values you\'ve lifted into an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(', ');
        ...
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' and apply to it the wrapped value. ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' contains no behavior and will do nothing more than apply the value inside the ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' to the function.');
      ie_close('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Identity (a -> b) ~> Identity a -> Identity b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('ap');
        ie_close('code');
        itext(' allows for values wrapped in an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' to be applied to functions also wrapped in an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        ...
        ie_open('code');
          itext('ap');
        ie_close('code');
        itext(' unwraps both the function and the value to be applied and applies the value to the function. Finally it will wrap the result of that application back into an ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Identity (f a) ~> (b -> f b) -> f (Identity a)\nApplicative f => Identity (f a) ~> TypeRep f -> f (Identity a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Apply');
        ie_close('code');
        itext(' returning function to be provided for its argument.');
      ie_close('p');
      ie_open('p');
        ie_open('code');
          itext('sequence');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Identity a ~> (a -> f b) -> f (Identity b)\nApplicative f => Identity a ~> (TypeRep f, (a -> f b)) -> f (Identity a b)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Identity a ~> (a -> Identity b) -> Identity b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Normally one of the ways ');
        ie_open('code');
          itext('Monad');
        ie_close('code');
        itext('s like ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' are able to be combined and have their effects applied is through ');
        ie_open('code');
          itext('chain');
        ie_close('code');
        itext('. However ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' is different because there are no effects to apply. ');
        ie_open('code');
          itext('chain');
        ie_close('code');
        itext(' will simply take a function that returns ');
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' and applies it to its value.');
      ie_close('p');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Identity');
        ie_close('code');
        itext(' instance will return the value being contained.');
      ie_close('p');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'CFbkT.render';
}
...
class CFbkT extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(CFbkT, templates);
...
var _IdentitySoy = __webpack_require__(222);
...
var CFbkT = function (_Component) {
  _inherits(CFbkT, _Component);

  function CFbkT() {
    _classCallCheck(this, CFbkT);

    return _possibleConstructorReturn(this, (CFbkT.__proto__ || Object.getPrototypeOf(CFbkT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CFbkT, _IdentitySoy2.default);

exports.default = CFbkT;
