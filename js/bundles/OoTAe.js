...
function $footerButtons(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    var tutorialObject__soy186 = opt_data.site.index.children['tutorials'].children[opt_data.page.parentId];
    if (opt_data.page.weight < tutorialObject__soy186.childIds.length) {
      if (opt_data.page.buttonTitle) {
        var nextPageUrl__soy191 = tutorialObject__soy186.children[tutorialObject__soy186.childIds[opt_data.page.weight]].url;
        ie_open('a', null, null,
            'href', nextPageUrl__soy191,
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s206_88c0813b(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
...
exports.__deltemplate_s206_88c0813b = __deltemplate_s206_88c0813b;
if (goog.DEBUG) {
  __deltemplate_s206_88c0813b.soyTemplateName = 'tutorial.__deltemplate_s206_88c0813b';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'tutorial', 0, __deltemplate_s206_88c0813b);
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s47_d34389eb(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
      'class', 'sidebar-link ' + (opt_data.page.active ? 'sidebar-link-selected' : ''),
      'href', opt_data.page.url);
...
exports.__deltemplate_s47_d34389eb = __deltemplate_s47_d34389eb;
if (goog.DEBUG) {
  __deltemplate_s47_d34389eb.soyTemplateName = 'Sidebar.__deltemplate_s47_d34389eb';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'sidebar', 0, __deltemplate_s47_d34389eb);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OoTAe", function() { return OoTAe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace OoTAe.
 * @public
 */

goog.module('OoTAe.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2012 = function() {
    $templateAlias2({code: 'Result e a = Err e | Ok a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('Result is a Sum Type similar to that of ');
      ie_open('a', null, null,
          'href', './Either.html');
        ie_open('code');
          itext('Either');
        ie_close('code');
      ie_close('a');
      itext(' with the added behaviour of accumulating the ');
      ie_open('a', null, null,
          'href', '#err');
        ie_open('code');
          itext('Err');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' being defined as a tagged union type, it captures the essence of disjunction as it provides either a ');
      ie_open('a', null, null,
          'href', './Either.html#left');
        ie_open('code');
          itext('Left');
        ie_close('code');
      ie_close('a');
      itext(' value or a ');
      ie_open('a', null, null,
          'href', './Either.html#right');
        ie_open('code');
          itext('Right');
        ie_close('code');
      ie_close('a');
      itext(' value but not both. With a ');
      ie_open('code');
        itext('Result');
      ie_close('code');
      itext(' the left contains the error information from an operation and the right contains the result.');
      ie_open('code');
        itext('Result');
      ie_close('code');
      itext(' is well suited for capturing disjunction when the cause of the "error" case needs to be communicated. For example, when executing a function and you exception is important or useful.');
    ie_close('p');
    ie_open('p');
      itext('A ');
      ie_open('code');
        itext('Result');
      ie_close('code');
      itext(' represents disjunction by using two constructors, ');
      ie_open('a', null, null,
          'href', '#err');
        ie_open('code');
          itext('Err');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' instance represents the positive result while ');
      ie_open('a', null, null,
          'href', '#err');
        ie_open('code');
          itext('Err');
        ie_close('code');
      ie_close('a');
      itext(' is considered the negative. With the exception of');
      ie_open('a', null, null,
          'href', '#coalesce');
        ie_open('code');
          itext('coalesce');
      ...
      ie_open('code');
        itext('Result');
      ie_close('code');
      itext(' returning methods on an instance will be applied to an ');
      ie_open('a', null, null,
          'href', '#ok');
        ie_open('code');
          itext('Ok');
        ie_close('code');
      ie_close('a');
      itext(' returning the result. If an instance is an ');
      ie_open('a', null, null,
          'href', '#err');
        ie_open('code');
          itext('Err');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' instance is returned with the same containing value.');
    ie_close('p');
    ie_open('p');
      ...
      ie_open('code');
        itext('Result');
      ie_close('code');
      itext(' constructor to construct an ');
      ie_open('a', null, null,
          'href', '#ok');
        ie_open('code');
          itext('Ok');
        ie_close('code');
      ie_close('a');
      itext(', but it will read better to just use ');
      ie_open('a', null, null,
          'href', '#ok');
        ie_open('code');
          itext('Ok');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Result :: a -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Most of the time, ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' is constructed using functions of your own making and helper functions like ');
        ie_open('a', null, null,
            'href', '#trycatch');
          ie_open('code');
            itext('tryCatch');
          ie_close('code');
        ie_close('a');
        itext(' or by employing one of the instance constructors, ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. This is due to the nature of ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' and most other Sum Types.');
      ie_close('p');
      ie_open('p');
        itext('As a matter of consistency and completion, a ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' instance can also be constructed using its TypeRep like any other type. The ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' constructor is a unary function that accepts any type ');
        ie_open('code');
          itext('a');
        ie_close('code');
        itext(' and returns a ');
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instance, wrapping the value passed to its argument.');
      ie_close('p');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result.Err :: e -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to construct an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
          ie_close('code');
        ie_close('a');
        itext(' instance that represents the "false" portion of a disjunction. When an instance is an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' returning methods will just return a new ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
          ie_close('code');
        ie_close('a');
        itext(' instance with the same containing value.');
      ie_close('p');
      ie_open('p');
        itext('The power of the ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        itext(' or a ');
        ie_open('a', null, null,
            'href', './Maybe.html#nothing');
          ie_open('code');
            itext('Nothing');
          ie_close('code');
        ie_close('a');
        itext(' is that it can hold meaningful information on why the flow is in this path. It will also accumulate this information when ');
        ie_open('a', null, null,
            'href', '#ap');
          ie_open('code');
            itext('ap');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result.Ok :: a -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to construct an ');
        ie_open('a', null, null,
            'href', '#ok');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' will wrap any given value in an');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result.of :: a -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Monad');
        ie_close('code');
        itext(' types. When working specifically with the ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext('type, the ');
        ...
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Result from \'crocks/Result\'\n\nconst { Ok, of } = Result\n\nof(\'Some result!\')\n//=> Ok "Some result!"\n\nof(undefined)\n//=> Ok undefined\n\nOk(\'Some result!\')\n//=> Ok "Some result!"\n\nOk(undefined)\n//=> Ok undefined\n\nResult(\'Some result!\')\n//=> Ok "Some result!"\n\nResult(undefined)\n//=> Ok undefined', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'topic-instance');
      ie_open('h2');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> b -> Boolean', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to compare the contained values of two ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(') with a contained value equal to the contained value of the ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' or the contained values are not equal by value thn ');
        ie_open('code');
          itext('equals');
        ie_close('code');
        itext(' will return ');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Semigroup s => Result e s ~> Result e s -> Result e s', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' instance wrapping the result of combining the two underlying ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' with the value of the first ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> (a -> b) -> Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' and apply to it the wrapped value. When run on an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('code');
          itext('map');
        ie_close('code');
        itext(' with return the error value in a new');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> Result e a -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> ((e -> d), (a -> b)) -> Result d b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('While it\'s more common to only ');
        ie_open('a', null, null,
            'href', '#map');
          ie_open('code');
            itext('map');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' there may come a time when you need to map over a ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' regardless of wether it\'s an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
      ...
      ie_open('p');
        ie_open('code');
          itext('bimap');
        ie_close('code');
        itext(' takes two mapping functions as its arguments. The first function is used to map an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
          ie_close('code');
        ie_close('a');
        itext(' instance, while the second maps an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' only provides a means to map an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
          ie_close('code');
        ie_close('a');
        itext(' instance exclusively using');
        ie_open('a', null, null,
            'href', '#map');
          ie_open('code');
            itext('map');
          ie_close('code');
        ie_close('a');
        itext('. If the need arises to map an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
          ie_close('code');
        ie_close('a');
        itext(' instance exclusively, then ');
        ie_open('code');
          itext('bimap');
        ie_close('code');
        itext(' can be used, passing the mapping function to the first argument and ');
        ie_open('a', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e (a -> b) ~> Result e a -> Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_close('p');
      ie_open('p');
        itext('When either instance is an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. This can be used to safely combine multiple values under a given combination function. If any of the inputs results in an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
          ie_close('code');
        ie_close('a');
        itext(' than they will never be applied to the function and not provide exceptions or unexpected results. However if the value in both ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Result e (f a) ~> (b -> f b) -> f (Result e a)\nApplicative f => Result e (f a) ~> TypeRep f -> f (Result e a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Apply');
        ie_close('code');
        itext(' returning function is provided for its argument. This will be used in the case that the ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' instance is a ');
      ...
      ie_open('p');
        ...
        itext(').');
      ie_close('p');
      $templateAlias2({code: 'import Result from \'crocks/Result\'\n\nimport Identity from \'crocks/Identity\'\n\nconst { Err, Ok } = Result\n\n// arrayOf :: a -> [ a ]\nconst arrayOf =\n  x => [ x ]\n\nOk([ 1, 2, 3 ])\n  .sequence(arrayOf)\n//=> [ Ok 1, Ok 2, Ok 3 ]\n\nErr(\'no array here\')\n  .sequence(arrayOf)\n//=> [ Err "no array here" ]\n\nOk(Identity.of(42))\n  .sequence(Identity)\n//=> Identity (Ok 42)\n\nErr(0)\n  .sequence(Identity)\n//=> Identity (Err 0)', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'traverse',
            'href', '#traverse');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Result e a ~> (c -> f c), (a -> f b)) -> f Result e b\nApplicative f => Result e a ~> (TypeRep f, (a -> f b)) -> f Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext('. This will be used in the case that the ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' instance is a ');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> (a -> Result e b) -> Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' returning function as its argument. When invoked on an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('code');
          itext('chain');
        ie_close('code');
        itext(' will not run the function, but will instead return a new ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
          ie_close('code');
        ie_close('a');
        itext(' instance with the same containing value. When called on an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> ((e -> b), (a -> b))) -> Result c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('There will come a time in your flow that you will want to ensure you have an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('code');
          itext('coalesce');
        ie_close('code');
        itext(' expects two functions for it\'s inputs.');
      ie_close('p');
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> ((e -> a), (a -> e)) -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to map the value of a ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' instance and transform an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('code');
          itext('swap');
        ie_close('code');
        itext(' takes two functions as its arguments. The first function is used to map and transform an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(', while the second maps and transforms an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. If no mapping of the contained values is required for either instance, then ');
        ie_open('a', null, null,
            'href', '../functions/combinators.html#identity');
          ie_open('code');
            itext('identity');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result e a ~> ((e -> b), (a -> b)) -> b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to provide a means to map a given ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' instance folding it out of its container. ');
        ie_open('code');
          itext('either');
        ie_close('code');
        itext(' expects two functions as its arguments. The first is a function that will be used to map an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'tryCatch :: (* -> a) -> * -> Result e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used when you want to take any variadic function and wrap it with the added function of a ');
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' type. ');
        ie_open('code');
          itext('tryCatch');
        ie_close('code');
        itext(' will execute the function with the parameters passed and return either an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' when an exception is thrown.');
      ie_close('p');
      ie_open('p');
        itext('Although we do our best to not use ');
        ie_open('code');
          itext('Error');
        ie_close('code');
        itext(' to control program flow, there are times when we don\'t have full control over the behaviour of a function. The saviour in this situation is ');
        ie_open('code');
          itext('tryCatch');
        ie_close('code');
        itext('. You can wrap this funcition and it will always return a ');
        ie_open('code');
          itext('Result');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'import tryCatch from \'crocks/Result/tryCatch\'\n\ntryCatch(() => {\n  throw new Error(\'Simple error!\')\n})()\n// Err "Simple error!"\n\n// calculateArea :: (a, b) -> Number\nconst calculateArea = (width, height) => {\n  if (isNaN(width) || isNaN(height)) {\n    throw Error(\'Parameter is not a number!\')\n  }\n\n  return width * height\n}\n\n// tryCalculateArea :: (a, b) -> Result String Number\nconst tryCalculateArea =\n  tryCatch(calculateArea)\n\ntryCalculateArea(3, 6)\n//=> Ok 18\n\ntryCalculateArea(\'String\', 5)\n// Err "Error: Parameter is not a number!"\n\n// getLength :: a -> Number\nconst getLength = a =>\n  a.length\n\n// tryGetLength :: a -> Result String Number\nconst tryGetLength =\n  tryCatch(getLength)\n\ntryGetLength([ 3, 2, 1 ])\n//=> Ok 3\n\ntryGetLength()\n//=> Err "TypeError: Cannot read property \'length\' of undefined"', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'eithertoresult',
            'href', '#eithertoresult');
          itext('eitherToResult');
        ie_close('a');
      ie_close('h4');
      ie_open('p');
        ie_open('code');
          itext('crocks/Result/eitherToResult');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'eitherToResult :: Either b a -> Result b a\neitherToResult :: (a -> Either c b) -> a -> Result c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' will be lost and as such this transformation is considered lossy in that regard.');
      ie_close('p');
      ie_open('p');
        itext('Like all ');
        ie_open('code');
        ...
        ie_open('code');
          itext('eitherToMaybe');
        ie_close('code');
        itext(' has two possible signatures and will behave differently when passed either an ');
        ie_open('a', null, null,
            'href', './Either.html');
          ie_open('code');
            itext('Either');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Result/firstToResult');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'firstToResult :: e -> First a -> Result e a\nfirstToResult :: e -> (a -> First b) -> a -> Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
        ...
        ie_open('code');
          itext('firstToResult');
        ie_close('code');
        itext(' will turn a non-empty instance into an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. All empty instances will map to an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Result/lastToResult');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'lastToResult :: e -> Last a -> Result e a\nlastToResult :: e -> (a -> Last b) -> a -> Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Result/maybeToResult');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'maybeToResult :: e -> Maybe a -> Result e a\nmaybeToResult :: e -> (a -> Maybe b) -> a -> Result e b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
            'href', '../monoids/Maybe.html');
          ie_open('code');
            itext('Maybe');
          ie_close('code');
        ie_close('a');
        ...
        itext(' will turn a ');
        ie_open('a', null, null,
            'href', './Maybe.html#just');
          ie_open('code');
            itext('Just');
          ie_close('code');
        ie_close('a');
        itext(' instance into an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext('. This means that when used with the ');
        ie_open('a', null, null,
            'href', './Maybe.html#helper-functions');
          ie_open('code');
            itext('Maybe-helpers');
          ie_close('code');
        ie_close('a');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2012}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'OoTAe.render';
}
...
class OoTAe extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(OoTAe, templates);
...
var _ResultSoy = __webpack_require__(228);
...
var OoTAe = function (_Component) {
  _inherits(OoTAe, _Component);

  function OoTAe() {
    _classCallCheck(this, OoTAe);

    return _possibleConstructorReturn(this, (OoTAe.__proto__ || Object.getPrototypeOf(OoTAe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OoTAe, _ResultSoy2.default);

exports.default = OoTAe;
