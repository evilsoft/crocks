...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TCqOW", function() { return TCqOW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace TCqOW.
 * @public
 */

goog.module('TCqOW.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2240 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'State :: (s -> Pair a s) -> State s a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Typically instances of ');
        ie_open('code');
          itext('State');
        ie_close('code');
        itext(' are constructed using the provided construction helpers like ');
        ie_open('a', null, null,
            'href', '#get');
          ie_open('code');
            itext('get');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. While the provided helpers fit most situations, there are times where a ');
        ie_open('code');
          itext('State');
        ie_close('code');
        itext(' instance will need to be constructed "by-hand".');
      ie_close('p');
      ie_open('p');
        ...
        ie_open('code');
          itext('State');
        ie_close('code');
        itext(' can be constructed by passing a unary function that takes some type ');
        ie_open('code');
          itext('s');
        ie_close('code');
        itext(' as its input and returns a ');
        ie_open('a', null, null,
            'href', '../Pair.html');
          ie_open('code');
            itext('Pair');
        ...
        ie_open('code');
          itext('a');
        ie_close('code');
        itext(' in the first position and the same type ');
        ie_open('code');
          itext('s');
        ie_close('code');
        itext(' in second.');
      ie_close('p');
      ie_open('p');
        itext('While there is nothing that prevents the type ');
        ie_open('code');
          itext('s');
        ie_close('code');
        itext(' from varying, it is recommended to fix the type to a single type for all ');
        ie_open('code');
          itext('State');
        ie_close('code');
        itext(' instances that are used in a given flow.');
      ie_close('p');
      $templateAlias2({code: 'import Pair from \'crocks/Pair\'\nimport State from \'crocks/State\'\n\nState(state => Pair(state, state))\n//=> State s s\n\n// increaseBy :: Number -> State Number Number\nconst increaseBy = value =>\n  State(state => Pair(value, state + 1))\n\nincreaseBy(5)\n//=> State Number Number', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('get');
        ie_close('code');
        itext(' may be called with or without a function as its argument. When nothing is provided for the argument, the state will be applied to the resultant as is. The state will be mapped over any provided function that takes the same type as the state, with the result deposited in the resultant.');
      ie_close('p');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('State');
        ie_close('code');
        itext(' instance is fixed to in its state portion, ');
        ie_open('code');
          itext('s');
        ie_close('code');
        itext('.');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2240}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'TCqOW.render';
}
...
class TCqOW extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(TCqOW, templates);
...
var _StateSoy = __webpack_require__(229);
...
var TCqOW = function (_Component) {
  _inherits(TCqOW, _Component);

  function TCqOW() {
    _classCallCheck(this, TCqOW);

    return _possibleConstructorReturn(this, (TCqOW.__proto__ || Object.getPrototypeOf(TCqOW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TCqOW, _StateSoy2.default);

exports.default = TCqOW;
