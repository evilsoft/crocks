...
test('eitherToAsync transform', t => {
  ...
  const err = /eitherToAsync: Argument must be an Either or a Function that returns an Either/
...
test('eitherToAsync with Either returning function', t => {
  ...
  const err = /eitherToAsync: Argument must be a Function that returns an Either/
