...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sihnE", function() { return sihnE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace sihnE.
 * @public
 */

goog.module('sihnE.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2516 = function() {
    ie_open('p');
      itext('The ');
      ie_open('code');
        itext('crocks');
      ie_close('code');
      itext(' are the heart and soul of this library. This is where you will find all your favorite ADT\'s you have grown to love. They include gems such as:');
      ie_open('a', null, null,
          'href', 'Maybe.html');
        ie_open('code');
          itext('Maybe');
      ...
      ie_open('code');
        itext('IO');
      ie_close('code');
      itext(', to name a few. They are usually just a simple constructor that takes either a function or value (depending on the type) and will return you a "container" that wraps whatever you passed it. Each container provides a variety of functions that act as the operations you can do on the contained value. There are many types that share the same function names, but what they do from type to type may vary.');
    ie_close('p');
    ie_open('table');
      ie_open('thead');
        ie_open('tr');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2516}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'sihnE.render';
}
...
class sihnE extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(sihnE, templates);
...
var sihnE = function (_Component) {
  _inherits(sihnE, _Component);

  function sihnE() {
    _classCallCheck(this, sihnE);

    return _possibleConstructorReturn(this, (sihnE.__proto__ || Object.getPrototypeOf(sihnE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sihnE, _indexSoy2.default);

exports.default = sihnE;
