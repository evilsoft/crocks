...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "axxNY", function() { return axxNY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace axxNY.
 * @public
 */

goog.module('axxNY.incrementaldom');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Pair');
        ie_close('code');
        itext(' instancewrapping the result of combining the underlying ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' instances.');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' in its first position. As anadditional requirement, is that instances of the same ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('traverse');
        ie_close('code');
        itext(' method requires either an ');
        ie_open('code');
          itext('Applicative TypeRep');
        ie_close('code');
        itext(' or an ');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'axxNY.render';
}
...
class axxNY extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(axxNY, templates);
...
var axxNY = function (_Component) {
  _inherits(axxNY, _Component);

  function axxNY() {
    _classCallCheck(this, axxNY);

    return _possibleConstructorReturn(this, (axxNY.__proto__ || Object.getPrototypeOf(axxNY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(axxNY, _PairSoy2.default);

exports.default = axxNY;
