var pageComponent =
webpackJsonppageComponent([11,21,22,23],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "maWVY", function() { return maWVY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace maWVY.
 * @public
 */

goog.module('maWVY.incrementaldom');
      ...
      ie_open('tbody');
        ...
        ie_open('tr');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('a', null, null,
                'href', 'combinators.html#reverseapply');
              ie_open('code');
                itext('reverseApply');
              ie_close('code');
            ie_close('a');
      ...
      ie_open('tbody');
        ...
        ie_open('tr');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Foldable f => (a -> b) -> (c -> b -> c) -> f a -> c');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'maWVY.render';
}
...
class maWVY extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(maWVY, templates);
...
var maWVY = function (_Component) {
  _inherits(maWVY, _Component);

  function maWVY() {
    _classCallCheck(this, maWVY);

    return _possibleConstructorReturn(this, (maWVY.__proto__ || Object.getPrototypeOf(maWVY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(maWVY, _indexSoy2.default);

exports.default = maWVY;
