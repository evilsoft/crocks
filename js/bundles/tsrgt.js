...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tsrgt", function() { return tsrgt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
// This file was automatically generated from transformation-functions.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace tsrgt.
 * @public
 */

goog.module('tsrgt.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3014 = function() {
    ...
    ie_open('p');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(', for instance, would lose the ');
      ie_open('a', null, null,
          'href', '../crocks/Either.html#left');
        ie_open('code');
          itext('Left');
        ie_close('code');
      ie_close('a');
      ...
      ie_open('code');
        itext('Unit');
      ie_close('code');
      itext('. Conversely, if you move the other way around, from a ');
      ie_open('a', null, null,
          'href', '../crocks/Maybe.html');
        ie_open('code');
          itext('Maybe');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' you must provide a default ');
      ie_open('a', null, null,
          'href', '../crocks/Either.html#left');
        ie_open('code');
          itext('Left');
        ie_close('code');
      ie_close('a');
      itext(' value. Which means, if the inner ');
      ie_open('a', null, null,
          'href', '../crocks/Maybe.html');
        ie_open('code');
          itext('Maybe');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' of your provided value. As such, not all of these functions are guaranteed isomorphic. With some types you just cannot go back and forth and expect to retain information.');
    ie_close('p');
    ie_open('p');
    ...
    ie_open('table');
      ...
      ie_open('tbody');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#asynctopromise');
              ie_open('code');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Async e a -> Promise a e');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Async e b) -> a -> Promise b e');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#eithertoasync');
              ie_open('code');
                itext('eitherToAsync');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Either e a -> Async e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Either e b) -> a -> Async e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/First.html#eithertofirst');
              ie_open('code');
                itext('eitherToFirst');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Either b a -> First a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Either c b) -> a -> First b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/Last.html#eithertolast');
              ie_open('code');
                itext('eitherToLast');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Either b a -> Last a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Either c b) -> a -> Last b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Maybe.html#eithertomaybe');
              ie_open('code');
                itext('eitherToMaybe');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Either b a -> Maybe a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Either c b) -> a -> Maybe b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Result.html#eithertoresult');
              ie_open('code');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Either e a -> Result e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Either e b) -> a -> Result e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#firsttoasync');
              ie_open('code');
                itext('firstToAsync');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('e -> First a -> Async e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('e -> (a -> First b) -> a -> Async e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Either.html#firsttoeither');
              ie_open('code');
                itext('firstToEither');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> First a -> Either c a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> (a -> First b) -> a -> Either c b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/Last.html#firsttolast');
              ie_open('code');
                itext('firstToLast');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('First a -> Last a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> First b) -> a -> Last b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Maybe.html#firsttomaybe');
              ie_open('code');
                itext('firstToMaybe');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('First a -> Maybe a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> First b) -> a -> Maybe b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Result.html#firsttoresult');
              ie_open('code');
                itext('firstToResult');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> First a -> Result c a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> (a -> First b) -> a -> Result c b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#lasttoasync');
              ie_open('code');
                itext('lastToAsync');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('e -> Last a -> Async e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('e -> (a -> Last b) -> a -> Async e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Either.html#lasttoeither');
              ie_open('code');
                itext('lastToEither');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> Last a -> Either c a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> (a -> Last b) -> a -> Either c b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/First.html#lasttofirst');
              ie_open('code');
                itext('lastToFirst');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Last a -> First a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Last b) -> a -> First b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Maybe.html#lasttomaybe');
              ie_open('code');
                itext('lastToMaybe');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Last a -> Maybe a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Last b) -> a -> Maybe b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Result.html#lasttoresult');
              ie_open('code');
                itext('lastToResult');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> Last a -> Result c a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> (a -> Last b) -> a -> Result c b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Maybe.html#maybetoarray');
              ie_open('code');
                itext('maybeToArray');
              ie_close('code');
            ie_close('a');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#maybetoasync');
              ie_open('code');
                itext('maybeToAsync');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('e -> Maybe a -> Async e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('e -> (a -> Maybe b) -> a -> Async e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Either.html#maybetoeither');
              ie_open('code');
                itext('maybeToEither');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> Maybe a -> Either c a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> (a -> Maybe b) -> a -> Either c b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/First.html#maybetofirst');
              ie_open('code');
                itext('maybeToFirst');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Maybe a -> First a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Maybe b) -> a -> First b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/Last.html#maybetolast');
              ie_open('code');
                itext('maybeToLast');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Maybe a -> Last a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Maybe b) -> a -> Last b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Maybe a -> List a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Maybe b) -> a -> List b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Result.html#maybetoresult');
              ie_open('code');
                itext('maybeToResult');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> Maybe a -> Result c a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('c -> (a -> Maybe b) -> a -> Result c b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#resulttoasync');
              ie_open('code');
                itext('resultToAsync');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Result e a -> Async e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Result e b) -> a -> Async e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Either.html#resulttoeither');
              ie_open('code');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Result e a -> Either e a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Result e b) -> a -> Either e b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/First.html#resulttofirst');
              ie_open('code');
                itext('resultToFirst');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Result e a -> First a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Result e b) -> a -> First b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../monoids/Last.html#resulttolast');
              ie_open('code');
                itext('resultToLast');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Result e a -> Last a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Result e b) -> a -> Last b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Maybe.html#resulttomaybe');
              ie_open('code');
                itext('resultToMaybe');
              ie_close('code');
            ie_close('a');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Result e a -> Maybe a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Result e b) -> a -> Maybe b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
        ...
        ie_open('tr');
          ie_open('td');
            ie_open('a', null, null,
                'href', '../crocks/Tuple.html#tupletoarray');
              ie_open('code');
                itext('tupleToArray');
              ie_close('code');
            ie_close('a');
        ...
        ie_open('tr');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('Writer m a -> Pair m a');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> Writer m b) -> a -> Pair m b');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3014}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'tsrgt.render';
}
...
class tsrgt extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(tsrgt, templates);
...
var _transformationFunctionsSoy = __webpack_require__(238);

var _transformationFunctionsSoy2 = _interopRequireDefault(_transformationFunctionsSoy);
...
var tsrgt = function (_Component) {
  _inherits(tsrgt, _Component);

  function tsrgt() {
    _classCallCheck(this, tsrgt);

    return _possibleConstructorReturn(this, (tsrgt.__proto__ || Object.getPrototypeOf(tsrgt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tsrgt, _transformationFunctionsSoy2.default);

exports.default = tsrgt;
