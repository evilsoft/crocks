...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JNZIw", function() { return JNZIw; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace JNZIw.
 * @public
 */

goog.module('JNZIw.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('empty');
        ie_close('code');
        itext(' is the identity function, which echoes its input. ');
        ie_open('code');
          itext('empty');
        ie_close('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3277}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'JNZIw.render';
}
...
class JNZIw extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(JNZIw, templates);
...
var JNZIw = function (_Component) {
  _inherits(JNZIw, _Component);

  function JNZIw() {
    _classCallCheck(this, JNZIw);

    return _possibleConstructorReturn(this, (JNZIw.__proto__ || Object.getPrototypeOf(JNZIw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JNZIw, _EndoSoy2.default);

exports.default = JNZIw;
