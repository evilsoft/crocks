var pageComponent =
webpackJsonppageComponent([16,36,37,38],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LNIUm", function() { return LNIUm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace LNIUm.
 * @public
 */

goog.module('LNIUm.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2657 = function() {
    ...
    ie_open('ul');
      ...
      ie_open('li');
        ie_open('code');
          itext('propPathSatisfies :: [ String | Integer ] -> ((a -> Boolean) | Pred) -> Object -> Boolean');
        ie_close('code');
        itext(': an ');
        ie_open('code');
          itext('Object');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2657}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'LNIUm.render';
}
...
class LNIUm extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(LNIUm, templates);
...
var _predicateFunctionsSoy = __webpack_require__(236);
...
var LNIUm = function (_Component) {
  _inherits(LNIUm, _Component);

  function LNIUm() {
    _classCallCheck(this, LNIUm);

    return _possibleConstructorReturn(this, (LNIUm.__proto__ || Object.getPrototypeOf(LNIUm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LNIUm, _predicateFunctionsSoy2.default);

exports.default = LNIUm;
