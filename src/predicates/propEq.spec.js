...
test('propEq function', t => {
  ...
  t.ok(f(key, val, obj), 'accepts a string in the first argument')
  t.ok(f(keyN, val, obj), 'accepts a number in the first argument')
  ...
  t.ok(f(key, val, {}), 'accepts an object in the third argument')
  ...
  t.equals(propEq(key, val, obj), true, 'returns true when value exists on object')
