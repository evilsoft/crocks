...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HDOHU", function() { return HDOHU; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace HDOHU.
 * @public
 */

goog.module('HDOHU.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2912 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('logical and');
      ie_close('code');
      itext('. This is super helpful when combined with ');
      ie_open('code');
        itext('or');
      ie_close('code');
    ...
    ie_open('h4');
      ...
      ie_close('a');
    ie_close('h4');
    $templateAlias2({code: 'implies :: ((a -> Boolean) | Pred a) -> ((a -> Boolean) | Pred a) -> a -> Boolean', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      ie_open('code');
        itext('implies');
      ie_close('code');
      itext(' is a logic combinator that will combine the evaluation of two predicates over ');
      ie_open('code');
        itext('logical implication');
      ie_close('code');
      itext('. It takes any combination of predicate functions or ');
      ie_open('a', null, null,
          'href', '../crocks/Pred.html');
        ie_open('code');
          itext('Pred');
        ie_close('code');
      ie_close('a');
      itext('s as its first two arguments and will return a new predicate function that will return ');
      ie_open('code');
        itext('false');
      ie_close('code');
      itext(' when the first predicate evaluates to ');
      ie_open('code');
        itext('true');
      ie_close('code');
      itext(' and the second evaluates to ');
      ie_open('code');
        itext('false');
      ie_close('code');
      itext('. All other combinations will return ');
      ie_open('code');
        itext('true');
      ie_close('code');
      itext('.');
    ie_close('p');
    ie_open('p');
      itext('Implication is a very weak condition in regards to assertion of a value and is usually paired with disjunction over conjunction for types like ');
      ie_open('a', null, null,
          'href', '../crocks/Pred.html');
        ie_open('code');
          itext('Pred');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('unless');
      ie_close('code');
      itext(' can come into play. Just provide a predicate function (a function that returns a ');
      ie_open('code');
        itext('Boolean');
      ie_close('code');
      itext(') and a function to apply your desired modification. This will get you back a function that when you pass it a value, it will evaluate it and if false, will run your value through the provided function. Either the original or modified value will be returned depending on the result of the predicate. Check out ');
      ie_open('a', null, null,
          'href', '#when');
        ie_open('code');
          itext('when');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('Boolean');
      ie_close('code');
      itext(') and a function to apply your desired modification. This will get you back a function that when you pass it a value, it will evaluate it and if true, will run your value through the provided function. Either the original or modified value will be returned depending on the result of the predicate. Check out ');
      ie_open('a', null, null,
          'href', '#unless');
        ie_open('code');
          itext('unless');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2912}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'HDOHU.render';
}
...
class HDOHU extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(HDOHU, templates);
...
var _logicFunctionsSoy = __webpack_require__(235);
...
var HDOHU = function (_Component) {
  _inherits(HDOHU, _Component);

  function HDOHU() {
    _classCallCheck(this, HDOHU);

    return _possibleConstructorReturn(this, (HDOHU.__proto__ || Object.getPrototypeOf(HDOHU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HDOHU, _logicFunctionsSoy2.default);

exports.default = HDOHU;
