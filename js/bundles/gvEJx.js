...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gvEJx", function() { return gvEJx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
// This file was automatically generated from Either.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace gvEJx.
 * @public
 */

goog.module('gvEJx.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param813 = function() {
    $templateAlias2({code: 'Either c a = Left c | Right a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      ie_open('code');
        itext('Either');
      ie_close('code');
      itext(' is the canonical ');
      ie_open('code');
        itext('Sum');
      ie_close('code');
      itext(' type and is the base of all other ');
      ie_open('code');
        itext('Sum');
      ie_close('code');
      itext(' types included in ');
      ie_open('code');
        itext('crocks');
      ie_close('code');
      itext(', such as ');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' to name a few. Defined as a tagged union type, it captures the essence of disjunction as it provides either a ');
      ie_open('a', null, null,
          'href', '#left');
        ie_open('code');
          itext('Left');
    ...
    ie_open('p');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(', which fixes its "left side", or ');
      ie_open('a', null, null,
      ...
      ie_open('code');
        itext('Either');
      ie_close('code');
      itext(' is a functor in both it\'s ');
      ie_open('a', null, null,
          'href', '#left');
        ie_open('code');
          itext('Left');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' sides. This allows for the ability to vary the type on either side and is akin to the imperative ');
      ie_open('code');
        itext('if...else');
      ie_close('code');
      itext(' trees that are common in programming.');
    ie_close('p');
    ie_open('p');
      itext('Like most other types in ');
      ie_open('code');
        itext('crocks');
      ie_close('code');
      itext(', ');
      ie_open('code');
        itext('Either');
      ie_close('code');
      itext(' has a right bias in regard to instance methods like ');
      ie_open('a', null, null,
          'href', '#map');
        ie_open('code');
          itext('map');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext('. This behavior can be used to formally capture Error handling as the ');
      ie_open('a', null, null,
          'href', '#left');
        ie_open('code');
          itext('Left');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Either :: a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('An ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' is typically constructed by using one of the instance constructors provided on the ');
        ie_open('code');
          itext('TypeRep');
        ie_close('code');
        itext(': ');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. For consistency, an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' can be constructed using its ');
        ie_open('code');
          itext('TypeRep');
        ie_close('code');
        itext(' as a constructor. The constructor is a unary function that accepts any type ');
        ie_open('code');
          itext('a');
        ie_close('code');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instance, wrapping the value it was passed.');
      ie_close('p');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either.Left :: c -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to construct a ');
        ie_open('code');
          itext('Left');
        ie_close('code');
        itext(' instance of an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' that represents the');
        ie_open('code');
          itext('false');
        ie_close('code');
        itext(' portion of a disjunction. The ');
        ie_open('code');
          itext('Left');
        ie_close('code');
        itext(' constructor takes a value of any type and returns a ');
        ie_open('code');
          itext('Left');
        ie_close('code');
        itext(' instance wrapping the value passed to the constructor.');
      ie_close('p');
      ie_open('p');
        itext('When an instance is a ');
        ie_open('code');
          itext('Left');
        ie_close('code');
        itext(', most ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' returning methods on the instance will do nothing to the wrapped value and return another ');
        ie_open('code');
          itext('Left');
        ie_close('code');
        itext(' with the same initial value the ');
        ie_open('code');
          itext('Left');
        ie_close('code');
        itext(' instance was constructed with.');
      ie_close('p');
      $templateAlias2({code: 'import Either from \'crocks/Either\'\n\nimport chain from \'crocks/pointfree/chain\'\nimport compose from \'crocks/helpers/compose\'\nimport isString from \'crocks/predicates/isString\'\nimport ifElse from \'crocks/logic/ifElse\'\n\nconst { Left, Right } = Either\n\n// yell :: String -> String\nconst yell =\n  x => `${x.toUpperCase()}!`\n\n// safeYell :: a -> Either a String\nconst safeYell =  ifElse(\n  isString,\n  compose(Right, yell),\n  Left\n)\n\nRight(\'excite\')\n  .map(yell)\n//=> Right "EXCITE!"\n\nLeft(\'whisper\')\n  .map(yell)\n//=> Left "whisper"\n\nchain(safeYell, Right(\'outside voice\'))\n//=> Right "OUTSIDE VOICE!"\n\nchain(safeYell, Left({ level: \'inside voice\' }))\n//=> Left { level: \'inside voice\' }', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'right',
            'href', '#right');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either.Right :: a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to construct a ');
        ie_open('code');
          itext('Right');
        ie_close('code');
        itext(' instance of the an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' that represents the ');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either.of :: a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to lift any value into an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' as a ');
        ...
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Either from \'crocks/Either\'\n\nconst { Right } = Either\n\nEither.of(\'some string\')\n//=> Right "some string"\n\nEither.of(undefined)\n//=> Right undefined\n\nEither(\'some string\')\n//=> Right "some string"\n\nEither(undefined)\n//=> Right undefined\n\nRight(\'some string\')\n//=> Right "some string"\n\nRight(undefined)\n//=> Right undefined', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'topic-instance');
      ie_open('h2');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> b -> Boolean', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' of the same instance with an underlying value equal to the underlying value of the ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        ...
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' of the same instance or the underlying values are not equal, ');
        ie_open('code');
          itext('equals');
        ie_close('code');
        itext(' will return ');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Semigroup s => Either c s ~> Either c s -> Either c s', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('When an underlying ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
        ...
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' of the same type. Expecting an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' wrapping a ');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> (a -> b) -> Either c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to apply transformations to values ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> Either c a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' it encounters or the last ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
          ie_close('code');
        ie_close('a');
        itext(' if it does not encounter a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> ((c -> d), (a -> b)) -> Either d b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('The types and values that make up an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' can vary independently in both the ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' can be used to apply a transformation to a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
        ...
        ie_open('code');
          itext('bimap');
        ie_close('code');
        itext(' allows transformations for either.');
      ie_close('p');
      ie_open('p');
        ie_open('code');
          itext('bimap');
        ie_close('code');
        itext(' takes two mapping functions as its arguments. The first function is used to map a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' only provides a means to map a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext('. If the need arises to map a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('code');
          itext('bimap');
        ie_close('code');
        itext(' can be used, passing the mapping function to the first argument and an ');
        ie_open('a', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c (a -> b) ~> Either c a -> Either c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' instance containing the result of the application. ');
        ie_open('code');
          itext('ap');
        ie_close('code');
        itext(' requires that it is called on either a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
          ie_close('code');
        ie_close('a');
        itext(' containing anything or a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
      ...
      ie_close('p');
      ie_open('p');
        itext('When either instance is a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' containing the original value. This can be used to safely combine multiple values under a given combination function. If any of the inputs results in a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Either c (f a) ~> (b -> f b) -> f (Either c a)\nApplicative f => Either c (f a) ~> TypeRep f -> f (Either c a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('p');
        ...
        itext(' function.');
      ie_close('p');
      $templateAlias2({code: 'import Either from \'crocks/Either\'\n\nimport Identity from \'crocks/Identity\'\n\nconst { Left, Right } = Either\n\n// arrayOf :: a -> [ a ]\nconst arrayOf =\n  x => [ x ]\n\nRight([ 1, 2, 3 ])\n  .sequence(arrayOf)\n//=> [ Right 1, Right 2, Right 3 ]\n\nLeft(\'no array here\')\n  .sequence(arrayOf)\n//=> [ Left "no array here" ]\n\nRight(Identity.of(42))\n  .sequence(Identity)\n//=> Identity (Right 42)\n\nLeft(0)\n  .sequence(Identity)\n//=> Identity (Left 0)', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'traverse',
            'href', '#traverse');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Either c a ~> (d -> f d), (a -> f b)) -> f Either c b\nApplicative f => Either c a ~> (TypeRep f, (a -> f b)) -> f Either c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to apply the "effect" of an ');
        ie_open('code');
          itext('Apply');
        ie_close('code');
        itext(' to a value inside of an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(',');
        ...
        ie_open('code');
          itext('Apply');
        ie_close('code');
        itext('s "effect" on the value in the supplied ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext('.');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> (a -> Either c b) -> Either c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' wrapping the original value. When called on a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> ((c -> b), (a -> b)) -> Either c b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to take a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
          ie_close('code');
        ie_close('a');
        itext(' instance and not only map its internal value, but also to "promote" it to a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
        ...
        ie_open('code');
          itext('coalesce');
        ie_close('code');
        itext(' takes two unary functions as its arguments and will return a new ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> ((c -> d), (a -> b)) -> Either b d', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to map the value of an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' instance and transform a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('code');
          itext('swap');
        ie_close('code');
        itext(' takes two functions as its arguments. The first function is used to map and transform a ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(', while the second maps and transforms a ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Either c a ~> ((c -> b), (a -> b)) -> b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used as a means to map and extract a value from an ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' based on the context, ');
        ie_open('code');
          itext('either');
        ie_close('code');
        itext(' takes two functions as its arguments. The first will map any the value ');
        ie_open('a', null, null,
            'href', '#left');
          ie_open('code');
            itext('Left');
          ie_close('code');
        ie_close('a');
        itext(' in a left instance. While the second is used to map any ');
        ie_open('a', null, null,
            'href', '#right');
          ie_open('code');
            itext('Right');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Either/firstToEither');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'firstToEither :: c -> First a -> Either c a\nfirstToEither :: c -> (a -> First b) -> a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('p');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' and as such its is fixed to a ');
        ie_open('code');
          itext('()');
        ie_close('code');
        itext(' (unit) type. As a means to allow for convenient transformation, ');
        ie_open('code');
          itext('firstToEither');
        ie_close('code');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Either/lastToEither');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'lastToEither :: c -> Last a -> Either c a\nlastToEither :: c -> (a -> Last b) -> a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Either/maybeToEither');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'maybeToEither :: c -> Maybe a -> Either c a\nmaybeToEither :: c -> (a -> Maybe b) -> a -> Either c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
            'href', './Maybe.html');
      ...
      ie_open('p');
        ...
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Either from \'crocks/Either\'\n\nimport Maybe from \'crocks/Maybe\'\nimport compose from \'crocks/helpers/compose\'\nimport fanout from \'crocks/Pair/fanout\'\nimport identity from \'crocks/combinators/identity\'\nimport isObject from \'crocks/predicates/isObject\'\nimport maybeToEither from \'crocks/Either/maybeToEither\'\nimport merge from \'crocks/Pair/merge\'\nimport safe from \'crocks/Maybe/safe\'\n\nconst { Nothing, Just } = Maybe\nconst { Right } = Either\n\nmaybeToEither(false, Nothing())\n//=> Left false\n\nmaybeToEither(false, Just(true))\n//=> Right true\n\n// isValid :: a -> Either b Object\nconst isValid = compose(\n  merge(maybeToEither),\n  fanout(identity, safe(isObject))\n)\n\nRight(\'I am String\')\n  .chain(isValid)\n//=> Left "I am String"\n\nRight({ key: \'value\' })\n  .chain(isValid)\n//=> Right { key: "value" }\n\nRight(Nothing())\n  .chain(maybeToEither(\'Left\'))\n//=> Left "Left"\n\nRight(Just(\'42\'))\n  .chain(maybeToEither(\'Left\'))\n//=> Right "42"', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'resulttoeither',
            'href', '#resulttoeither');
          itext('resultToEither');
        ie_close('a');
      ie_close('h4');
      ie_open('p');
        ie_open('code');
          itext('crocks/Either/resultToEither');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'resultToEither :: Result e a -> Either e a\nresultToEither :: (a -> Result e b) -> a -> Either e a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
            'href', './Result.html');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instance wrapping the value contained in the original ');
        ie_open('code');
          itext('Ok');
        ie_close('code');
        itext('. If an ');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'gvEJx.render';
}
...
class gvEJx extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(gvEJx, templates);
...
var _EitherSoy = __webpack_require__(220);

var _EitherSoy2 = _interopRequireDefault(_EitherSoy);
...
var gvEJx = function (_Component) {
  _inherits(gvEJx, _Component);

  function gvEJx() {
    _classCallCheck(this, gvEJx);

    return _possibleConstructorReturn(this, (gvEJx.__proto__ || Object.getPrototypeOf(gvEJx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gvEJx, _EitherSoy2.default);

exports.default = gvEJx;
