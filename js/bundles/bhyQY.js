...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bhyQY", function() { return bhyQY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace bhyQY.
 * @public
 */

goog.module('bhyQY.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3310 = function() {
    $templateAlias2({code: 'First a = First (Maybe a)', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      ie_open('code');
        itext('First');
      ie_close('code');
      ...
      ie_open('code');
        itext('Monoid');
      ie_close('code');
      itext(' that will always return the first, non-empty value when two ');
      ie_open('code');
        itext('First');
      ie_close('code');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'First :: a -> First (Maybe a)\nFirst :: Maybe a -> First (Maybe a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('A ');
        ie_open('code');
          itext('First');
        ie_close('code');
        itext(' instance can be constructed by passing either a direct (unwrapped) value ');
        ie_open('code');
          itext('a');
        ie_close('code');
        itext(' or a ');
        ie_open('code');
          itext('Maybe a');
        ie_close('code');
        itext(' to the constructor. When a direct value is passed, the constructor will always wrap the value in a ');
        ie_open('code');
          itext('Just');
        ie_close('code');
      ...
      ie_close('p');
      ie_open('p');
        itext('Alternatively, by passing a ');
        ie_open('code');
          itext('Maybe a');
        ie_close('code');
        itext(', the user can programmatically provide an empty case to a given ');
        ie_open('code');
          itext('First');
        ie_close('code');
        itext(' by passing a ');
        ...
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import First from \'crocks/First\'\nimport Maybe from \'crocks/Maybe\'\n\nconst { Just, Nothing } = Maybe\n\nFirst(Just(22))\n//=> First( Just 22 )\n\nFirst(Nothing())\n//=> First( Nothing )\n\nFirst(undefined)\n//=> First( Just undefined )\n\nFirst(\'string\')\n//=> First( Just "string" )', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'First.empty :: () -> First a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('empty');
        ie_close('code');
      ...
      ie_close('p');
      $templateAlias2({code: 'import First from \'crocks/First\'\n\nconst { empty } = First\n\nFirst.empty()\n//=> First( Nothing )\n\nFirst(3)\n  .concat(empty())\n//=> First( Just 3 )\n\nempty()\n  .concat(First(3))\n//=> First( Just 3 )', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'topic-instance');
      ie_open('h2');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'First a ~> b -> Boolean', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'First a ~> First a -> First a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('concat');
        ie_close('code');
        ...
        ie_open('code');
          itext('First');
        ie_close('code');
        itext(', it will always provide the first non-empty value. Any subsequent non-empty values will be thrown away and will always result in the first non-empty value.');
      ie_close('p');
      $templateAlias2({code: 'import First from \'crocks/First\'\nimport concat from \'crocks/pointfree/concat\'\n\nconst a = First(\'a\')\nconst b = First(\'b\')\nconst c = First(\'c\')\n\na.concat(b)\n//=> First( Just "a" )\n\nb.concat(a)\n//=> First( Just "b" )\n\nconcat(c, concat(b, a))\n//=> First( Just "a" )\n\nconcat(concat(c, b), a)\n//=> First( Just "a" )\n\nconcat(concat(a, b), c)\n//=> First( Just "c" )', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'option',
            'href', '#option');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'First a ~> a -> a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('First');
        ie_close('code');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'First a ~> () -> Maybe a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('valueOf');
        ie_close('code');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/First/eitherToFirst');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'eitherToFirst :: Either b a -> First a\neitherToFirst :: (a -> Either c b) -> a -> First b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/First/lastToFirst');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'lastToFirst :: Last a -> First a\nlastToFirst :: (a -> Last b) -> a -> First b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
            'href', './Last.html');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/First/maybeToFirst');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'maybeToFirst :: Maybe a -> First a\nmaybeToFirst :: (a -> Maybe b) -> a -> First b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
            'href', '../crocks/Maybe.html');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/First/resultToFirst');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'resultToFirst :: Result e a -> First a\nresultToFirst :: (a -> Result e b) -> a -> First b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('a', null, null,
            'href', '../crocks/Result.html');
          ie_open('code');
            itext('Result');
          ie_close('code');
        ie_close('a');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3310}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'bhyQY.render';
}
...
class bhyQY extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(bhyQY, templates);
...
var _FirstSoy = __webpack_require__(245);

var _FirstSoy2 = _interopRequireDefault(_FirstSoy);
...
var bhyQY = function (_Component) {
  _inherits(bhyQY, _Component);

  function bhyQY() {
    _classCallCheck(this, bhyQY);

    return _possibleConstructorReturn(this, (bhyQY.__proto__ || Object.getPrototypeOf(bhyQY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bhyQY, _FirstSoy2.default);

exports.default = bhyQY;
