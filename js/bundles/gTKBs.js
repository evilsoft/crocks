...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gTKBs", function() { return gTKBs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace gTKBs.
 * @public
 */

goog.module('gTKBs.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1515 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Pair a (f b) ~> (c -> f c) -> f (Pair a b)\nApplicative f => Pair a (f b) ~> TypeRep f -> f (Pair a b)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Pair a b ~> ((d -> f d), (b -> f c)) -> f (Pair a c)\nApplicative f => Pair a b ~> (TypeRep f, (b -> f c)) -> f (Pair a c)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1515}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'gTKBs.render';
}
...
class gTKBs extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(gTKBs, templates);
...
var _PairSoy = __webpack_require__(224);
...
var gTKBs = function (_Component) {
  _inherits(gTKBs, _Component);

  function gTKBs() {
    _classCallCheck(this, gTKBs);

    return _possibleConstructorReturn(this, (gTKBs.__proto__ || Object.getPrototypeOf(gTKBs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gTKBs, _PairSoy2.default);

exports.default = gTKBs;
