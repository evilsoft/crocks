var pageComponent =
webpackJsonppageComponent([3,13,14,15],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CIonW", function() { return CIonW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace CIonW.
 * @public
 */

goog.module('CIonW.incrementaldom');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('em');
          itext('should');
        ie_close('em');
        itext(' work, with no additional compilation in all current browsers (Edge, Safari, Chrome, Firefox), if it does not, please file an issue as I really, really want it to. :smile_cat:.');
      ie_close('p');
      ie_open('p');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'CIonW.render';
}
...
class CIonW extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(CIonW, templates);
...
var _gettingStartedSoy = __webpack_require__(225);
...
var CIonW = function (_Component) {
  _inherits(CIonW, _Component);

  function CIonW() {
    _classCallCheck(this, CIonW);

    return _possibleConstructorReturn(this, (CIonW.__proto__ || Object.getPrototypeOf(CIonW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CIonW, _gettingStartedSoy2.default);

exports.default = CIonW;
