...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kqwyw", function() { return kqwyw; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace kqwyw.
 * @public
 */

goog.module('kqwyw.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3750 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Sum :: Number -> Sum Number', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('Sum');
        ie_close('code');
        itext(' provides addition on ');
        ie_open('code');
          itext('Number');
        ie_close('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3750}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'kqwyw.render';
}
...
class kqwyw extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(kqwyw, templates);
...
var _SumSoy = __webpack_require__(250);
...
var kqwyw = function (_Component) {
  _inherits(kqwyw, _Component);

  function kqwyw() {
    _classCallCheck(this, kqwyw);

    return _possibleConstructorReturn(this, (kqwyw.__proto__ || Object.getPrototypeOf(kqwyw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kqwyw, _SumSoy2.default);

exports.default = kqwyw;
