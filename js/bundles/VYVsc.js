...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VYVsc", function() { return VYVsc; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace VYVsc.
 * @public
 */

goog.module('VYVsc.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Just');
        ie_close('code');
        itext(', signalling the validity of the wrapped value.');
      ie_close('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Maybe.type :: () -> String', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('type');
        ie_close('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param906}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'VYVsc.render';
}
...
class VYVsc extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(VYVsc, templates);
...
var _MaybeSoy = __webpack_require__(219);
...
var VYVsc = function (_Component) {
  _inherits(VYVsc, _Component);

  function VYVsc() {
    _classCallCheck(this, VYVsc);

    return _possibleConstructorReturn(this, (VYVsc.__proto__ || Object.getPrototypeOf(VYVsc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VYVsc, _MaybeSoy2.default);

exports.default = VYVsc;
