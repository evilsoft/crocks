var pageComponent =
webpackJsonppageComponent([20,36,37,38],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HSqjG", function() { return HSqjG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace HSqjG.
 * @public
 */

goog.module('HSqjG.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2296 = function() {
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'unsetPath :: [ String | Integer ] -> (Object | Array) -> (Object | Array)', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      ...
      ie_open('code');
        itext('unsetPath');
      ie_close('code');
      itext(' is will return a new instance with the property or index removed.');
    ie_close('p');
    ie_open('p');
      itext('The provided path can be a mixture of either ');
      ie_open('code');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2296}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'HSqjG.render';
}
...
class HSqjG extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(HSqjG, templates);
...
var _helpersSoy = __webpack_require__(232);
...
var HSqjG = function (_Component) {
  _inherits(HSqjG, _Component);

  function HSqjG() {
    _classCallCheck(this, HSqjG);

    return _possibleConstructorReturn(this, (HSqjG.__proto__ || Object.getPrototypeOf(HSqjG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HSqjG, _helpersSoy2.default);

exports.default = HSqjG;
