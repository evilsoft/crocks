...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eSmgW", function() { return eSmgW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace eSmgW.
 * @public
 */

goog.module('eSmgW.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param341 = function() {
    ...
    ie_close('p');
    $templateAlias2({code: 'const propOr = require(\'crocks/helpers/propOr\')\n\nconst data = {\n  foo: \'bar\',\n  null: null,\n  nan: NaN,\n  undef: undefined\n}\n\n// def :: (String | Integer) -> a -> b\nconst def =\n  propOr(\'default\')\n\ndef(\'foo\', data)\n//=> "bar"\n\ndef(\'null\', data)\n//=> null\n\ndef(\'nan\', data)\n//=> NaN\n\ndef(\'baz\', data)\n//=> "default"\n\ndef(\'undef\', data)\n//=> "default"', mode: 'javascript'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'proppathor',
          'href', '#proppathor');
    ...
    ie_close('p');
    $templateAlias2({code: 'const propPathOr = require(\'crocks/helpers/propPathOr\')\n\nconst data = {\n  foo: {\n    bar: \'bar\',\n    null: null,\n    nan: NaN,\n    undef: undefined\n  },\n  arr: [ 1, 2 ]\n}\n\n// def :: [ String | Integer ] -> a -> b\nconst def =\n  propPathOr(\'default\')\n\ndef([ \'foo\', \'bar\' ], data)\n//=> "bar"\n\ndef([ \'baz\', \'tommy\' ], data)\n//=> "default"\n\ndef([ \'foo\', \'null\' ], data)\n//=> null\n\ndef([ \'foo\', \'nan\' ], data)\n//=> NaN\n\ndef([ \'foo\', \'undef\' ], data)\n//=> "default"\n\ndef([ \'arr\', \'length\' ], data)\n//=> 2', mode: 'javascript'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'tap',
          'href', '#tap');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'eSmgW.render';
}
...
class eSmgW extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(eSmgW, templates);
...
var eSmgW = function (_Component) {
  _inherits(eSmgW, _Component);

  function eSmgW() {
    _classCallCheck(this, eSmgW);

    return _possibleConstructorReturn(this, (eSmgW.__proto__ || Object.getPrototypeOf(eSmgW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eSmgW, _helpersSoy2.default);

exports.default = eSmgW;
