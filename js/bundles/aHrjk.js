...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aHrjk", function() { return aHrjk; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace aHrjk.
 * @public
 */

goog.module('aHrjk.incrementaldom');
  ...
  var param1227 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Maybe :: a -> Maybe a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Most of the time, ');
        ie_open('code');
          itext('Maybe');
        ie_close('code');
        itext(' is constructed using helper functions like ');
        ie_open('a', null, null,
            'href', '#safe');
          ie_open('code');
            itext('safe');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Maybe (f a) ~> (b -> f b) -> f (Maybe a)\nApplicative f => Maybe (f a) ~> TypeRep f -> f (Maybe a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Apply f => Maybe a ~> (c -> f c), (a -> f b)) -> f Maybe b\nApplicative f => Maybe a ~> (TypeRep f, (a -> f b)) -> f Maybe b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('coalesce');
        ie_close('code');
        itext(' expects two functions for its inputs.');
      ie_close('p');
      ie_open('p');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('either');
        ie_close('code');
        itext(' expects two functions as its arguments. The first is a pointed function that will be used when invoked on a ');
        ie_open('code');
          itext('Nothing');
        ie_close('code');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Maybe/find');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'find :: Foldable f => ((a -> Boolean) | Pred) -> f a -> Maybe a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Using a provided predicate function or a ');
        ie_open('code');
          itext('Pred');
        ie_close('code');
        itext(' datatype, ');
        ...
        ie_open('code');
          itext('Foldable');
        ie_close('code');
        itext(' instance and executes for every value in the ');
        ie_open('code');
          itext('Foldable');
        ie_close('code');
        itext(', skipping empty indexes. ');
        ie_open('code');
          itext('find');
        ie_close('code');
        itext(' then returns the first value it finds that passes the predicate. If found, ');
        ie_open('code');
          itext('find');
        ie_close('code');
        itext(' returns the value in a ');
        ie_open('code');
          itext('Just');
        ie_close('code');
        itext(', otherwise a ');
        ...
        itext('is returned.');
      ie_close('p');
      $templateAlias2({code: 'import find from \'crocks/Maybe/find\'\nimport Pred from \'crocks/Pred\'\nimport isNumber from \'crocks/predicates/isNumber\'\n\n// isEven :: Number -> Boolean\nconst isEven =\n  x => x % 2 === 0\n\n// largeNumber :: Pred a\nconst largeNumber =\n  Pred(isNumber)\n    .concat(Pred(x => x > 100))\n\nfind(largeNumber, [ 10, \'12\', 150, 200, 2000 ])\n//=> Just 150\n\nfind(largeNumber, [ 1, 2, 3, 4, 5 ])\n//=> Nothing\n\nfind(isEven, [ 1, 2, 3, 4, 5 ])\n//=> Just 2', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'getpath',
            'href', '#getpath');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Maybe/getPath');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'getPath :: [ (String | Integer) ] -> a -> Maybe b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('While ');
        ie_open('a', null, null,
            'href', '#getprop');
        ...
        ie_open('code');
          itext('getPath');
        ie_close('code');
        itext(' (formally known as ');
        ie_open('code');
          itext('propPath');
        ie_close('code');
        itext(') and pass it a left-to-right traversal path of keys, indices or a combination of both. This will kick you back a function that behaves just like ');
        ie_open('a', null, null,
            'href', '#getprop');
          ie_open('code');
            itext('getProp');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Maybe/getProp');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'getProp :: (String | Integer) -> a -> Maybe b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('safe');
        ie_close('code');
        itext('. Provide a predicate (a function that returns a Boolean) or a ');
        ie_open('a', null, null,
            'href', './Pred.html');
          ie_open('code');
            itext('Pred');
          ie_close('code');
        ie_close('a');
        itext(' datatypea and the value to be lifted. The value will be evaluated against the predicate, and will lift it into a ');
        ie_open('code');
          itext('Just');
        ie_close('code');
        itext(' if true and a ');
      ...
      ie_open('p');
        ...
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'safeAfter :: ((b -> Boolean) | Pred) -> (a -> b) -> a -> Maybe b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Many times, you might want to lift the result of a function into a ');
        ie_open('code');
          itext('Maybe');
        ie_close('code');
        itext(' based on some predicate. This may be because some parts of our code might return unsafe values for further computations we may like to perform. Similar to ');
        ie_open('a', null, null,
            'href', '#safe');
          ie_open('code');
            itext('safe');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' or a predicate function, along with a unary function. ');
        ie_open('code');
          itext('safeAfter');
        ie_close('code');
        itext(' then gives you a new  function, which when invoked evaluates the predicate against the result of executing the unary function. This result is then lifted into a ');
        ie_open('code');
          itext('Just');
        ie_close('code');
        itext(' if the predicate evaluates to ');
        ie_open('code');
          itext('true');
        ie_close('code');
        itext(', or a ');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Maybe/maybeToArray');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'maybeToArray :: Maybe a -> [ a ]\nmaybeToArray :: (a -> Maybe b) -> a -> [ b ]', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to transform a given ');
        ie_open('code');
          itext('Maybe');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instance into a single element ');
        ie_open('code');
          itext('Array');
        ie_close('code');
        itext(', wrapping the original value contained within the ');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instances will map to an empty ');
        ie_open('code');
          itext('Array');
        ie_close('code');
        itext('.');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'aHrjk.render';
}
...
class aHrjk extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(aHrjk, templates);
...
var _MaybeSoy = __webpack_require__(223);
...
var aHrjk = function (_Component) {
  _inherits(aHrjk, _Component);

  function aHrjk() {
    _classCallCheck(this, aHrjk);

    return _possibleConstructorReturn(this, (aHrjk.__proto__ || Object.getPrototypeOf(aHrjk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aHrjk, _MaybeSoy2.default);

exports.default = aHrjk;
