var pageComponent =
webpackJsonppageComponent([2,13,14,15],[
/* 0 */
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList239 = opt_data.page.childIds;
              var childIdListLen239 = childIdList239.length;
              for (var childIdIndex239 = 0; childIdIndex239 < childIdListLen239; childIdIndex239++) {
                var childIdData239 = childIdList239[childIdIndex239];
                var topic__soy229 = opt_data.page.children[childIdData239];
                if (! topic__soy229.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy229.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy229.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn13 = topic__soy229.title;
