...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "XdWxb", function() { return XdWxb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace XdWxb.
 * @public
 */

goog.module('XdWxb.incrementaldom');
      ...
      ie_open('tbody');
        ...
        ie_open('tr');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('code');
              itext('(a -> m c d) -> (b -> m c d) -> m a b -> m c d');
            ie_close('code');
          ie_close('td');
          ie_open('td', null, null,
              'style', 'text-align:left');
      ...
      ie_open('tbody');
        ...
        ie_open('tr');
          ...
          ie_open('td', null, null,
              'style', 'text-align:left');
            ie_open('a', null, null,
                'href', '../crocks/Async.html#bichain');
              ie_open('code');
                itext('Async');
              ie_close('code');
            ie_close('a');
            itext(', ');
            ie_open('a', null, null,
                'href', '../crocks/Either.html#bichain');
              ie_open('code');
                itext('Either');
              ie_close('code');
            ie_close('a');
            itext(', ');
            ie_open('a', null, null,
                'href', '../crocks/Maybe.html#bichain');
              ie_open('code');
                itext('Maybe');
              ie_close('code');
            ie_close('a');
            itext(', ');
            ie_open('a', null, null,
                'href', '../crocks/Result.html#bichain');
              ie_open('code');
                itext('Result');
              ie_close('code');
            ie_close('a');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'XdWxb.render';
}
...
class XdWxb extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(XdWxb, templates);
...
var XdWxb = function (_Component) {
  _inherits(XdWxb, _Component);

  function XdWxb() {
    _classCallCheck(this, XdWxb);

    return _possibleConstructorReturn(this, (XdWxb.__proto__ || Object.getPrototypeOf(XdWxb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XdWxb, _pointfreeFunctionsSoy2.default);

exports.default = XdWxb;
