var pageComponent =
webpackJsonppageComponent([29,34,35,36],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SKuRN", function() { return SKuRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace SKuRN.
 * @public
 */

goog.module('SKuRN.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param855 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Applicative TypeRep t, Apply f => Maybe (f a) ~> (t | (b -> f b)) -> f (Maybe a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Applicative TypeRep t, Apply f => Maybe a ~> ((t | (c -> f c)), (a -> f b)) -> f Maybe b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param855}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'SKuRN.render';
}
...
class SKuRN extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(SKuRN, templates);
...
var _MaybeSoy = __webpack_require__(221);
...
var SKuRN = function (_Component) {
  _inherits(SKuRN, _Component);

  function SKuRN() {
    _classCallCheck(this, SKuRN);

    return _possibleConstructorReturn(this, (SKuRN.__proto__ || Object.getPrototypeOf(SKuRN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SKuRN, _MaybeSoy2.default);

exports.default = SKuRN;
