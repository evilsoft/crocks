...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cujJT", function() { return cujJT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace cujJT.
 * @public
 */

goog.module('cujJT.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param717 = function() {
    $templateAlias2({code: 'Const c a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
      itext('Commonly known as the Delta (\u0394) Functor, ');
      ie_open('code');
        itext('Const');
      ie_close('code');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('Semigroup');
      ie_close('code');
      itext(' and can combine two instances using ');
      ie_open('a', null, null,
          'href', '#concat');
        ie_open('code');
          itext('concat');
        ie_close('code');
      ie_close('a');
      itext('. As a special bonus, is also acts as an ');
      ie_open('code');
        itext('Apply');
      ie_close('code');
      itext(' as ');
    ...
    ie_open('p');
      ...
      ie_open('a', null, null,
        ...
        ie_close('code');
      ie_close('a');
      itext(' function on both the Constructor and Instance. Like, the ');
      ie_open('code');
        itext('Semigroup');
      ie_close('code');
      itext(' having the ability to be used as an ');
      ie_open('code');
        itext('Apply');
      ie_close('code');
      itext(', ');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Const :: TypeRep T => T -> Const T\nConst c :: c -> Const c a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('Const');
        ie_close('code');
        itext(' is a Type Constructor that take a Constructor or TypeRep and will give back an Instance Constructor that will take a value of the type provided.');
      ie_close('p');
      $templateAlias2({code: 'import Const from \'crocks/Const\'\n\n// StrConst :: Const String a\nconst StrConst =\n  Const(String)\n\n// BoolConst :: Const Boolean a\nconst BoolConst =\n  Const(Boolean)\n\nStrConst(\'always and forever\')\n//=> Const(String) "always and forever"\n\nBoolConst(false)\n//=> Const(Boolean) false', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Monoid m => Const(m).empty :: () -> Const m ()', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('When ');
        ie_open('code');
          itext('Const');
        ...
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext(' type, we automatically get a ');
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext(' implementation by creating an instance that points to the ');
        ie_open('code');
          itext('empty');
        ie_close('code');
        itext(' element of the underlying ');
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext('. As this is just a "pass through" of the underlying ');
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext(', everything valid for the underlying type, holds true for ');
        ie_open('code');
          itext('Const');
        ie_close('code');
        itext('.');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('TypeError');
        ie_close('code');
        itext(' if the underlying Type does not point to a type of ');
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext('.');
      ie_close('p');
      $templateAlias2({code: '', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'of',
            'href', '#of');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Monoid m => Const(m).of :: a -> Const m a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('When ');
        ie_open('code');
          itext('Const');
        ...
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext(' type, we automatically get an ');
        ie_open('code');
          itext('Applicative');
        ie_close('code');
        itext(' implementation by creating an instance that points to the ');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Applicative');
        ie_close('code');
        itext(' laws work due to the fact that we can derive an ');
        ie_open('code');
          itext('Apply');
        ie_close('code');
        itext(' by mapping all every morphinism to the ');
        ie_open('code');
          itext('concat');
        ie_close('code');
        itext(' method of a pointed to ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext('. As, we must be a ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' before we can be a ');
        ie_open('code');
          itext('Monoid');
        ie_close('code');
        itext(', ');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Semigroup s => Const s a ~> Const s a -> Const s a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('concat');
        ie_close('code');
        ...
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' type, it will combine the two values that each ');
        ie_open('code');
          itext('Const');
        ie_close('code');
        itext(' points to using the ');
        ie_open('code');
          itext('concat');
        ie_close('code');
      ...
      ie_open('p');
        ...
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Const from \'crocks/Const\'\n\nimport Maybe from \'crocks/Maybe\'\nimport Sum from \'crocks/Sum\'\n\nconst { Just } = Maybe\n\nconst ArrayConst =\n  Const(Array)\n\nconst MaybeConst =\n  Const(Maybe)\n\nArrayConst([ \'a\', \'b\' ])\n  .concat(ArrayConst([ \'c\' ]))\n//=> Const(Array) [ "a", "b", "c" ]\n\n// a :: Maybe Sum\nconst a =\n  Just(Sum(10))\n\n// b :: Maybe Sum\nconst b =\n  Just(Sum(32))\n\nMaybeConst(a)\n  .concat(MaybeConst(b))\n  .valueOf()\n//=> Just (Sum 42)', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'map',
            'href', '#map');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Semigroup s => Const s (a -> b) ~> Const s a -> Const s b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('The unique nature of the ');
        ie_open('code');
          itext('Const');
        ie_close('code');
        itext(' functor allows any underlying ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' to act an an ');
        ...
        ie_open('code');
          itext('Const');
        ie_close('code');
        itext(' is applied to another ');
        ie_open('code');
          itext('Const');
        ie_close('code');
        itext(' whose underlying ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext('s match, the ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext('s will be combined by calling');
        ie_open('code');
          itext('concat');
        ie_close('code');
        itext(' on the underlying ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext('.');
      ...
      ie_open('p');
        ...
        itext(' type.');
      ie_close('p');
      $templateAlias2({code: 'import Const from \'crocks/Const\'\n\nconst ArrayConst =\n  Const(Array)\n\nArrayConst([ 33 ])\n  .valueOf()\n//=> [ 33 ]\n\nArrayConst([ 35 ])\n  .concat(ArrayConst([ 20 ]))\n  .valueOf()\n//=> [ 35, 20 ]', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'cujJT.render';
}
...
class cujJT extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(cujJT, templates);
...
var cujJT = function (_Component) {
  _inherits(cujJT, _Component);

  function cujJT() {
    _classCallCheck(this, cujJT);

    return _possibleConstructorReturn(this, (cujJT.__proto__ || Object.getPrototypeOf(cujJT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cujJT, _ConstSoy2.default);

exports.default = cujJT;
