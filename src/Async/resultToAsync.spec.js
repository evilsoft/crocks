...
test('resultToAsync transform', t => {
  ...
  const err = /resultToAsync: Argument must be a Result or a Function that returns a Result/
...
test('resultToAsync with Result returning function', t => {
  ...
  const err = /resultToAsync: Argument must be a Function that returns a Result/
