...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "uQBsp", function() { return uQBsp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
// This file was automatically generated from Tuple.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace uQBsp.
 * @public
 */

goog.module('uQBsp.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param2388 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Tuple :: Number -> n-Tuple *...n', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('Tuple');
        ie_close('code');
        itext(' is a type constructor that takes a non-zero, positive ');
        ie_open('code');
          itext('Integer');
        ie_close('code');
        itext(' as its argument. Instead of an instance, it will return a constructor that is used to construct an ');
        ie_open('code');
          itext('n');
        ie_close('code');
        itext(' sized ');
        ...
        ie_open('code');
          itext('n');
        ie_close('code');
        itext(' is the number of independent values that can be represented.');
      ie_close('p');
      ie_open('p');
        itext('The resulting ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' constructor is parameterized as an ');
        ie_open('code');
          itext('n-Functor');
        ie_close('code');
        itext(', where each parameter can vary from instance to instance.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\n\n// Triple :: 3-Tuple\nconst Triple =\n  Tuple(3)\n\n// Quad :: 4-Tuple\nconst Quad =\n  Tuple(4)\n\nTriple(false, true, 45)\n//=> 3-Tuple (false, true, 45)\n\nQuad({ a: true }, [ 1, 2, 3 ], 60, \'string\')\n//=> 4-Tuple ({ a: true }, [ 1, 2, 3 ], 60, "string")', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'topic-instance');
      ie_open('h2');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'n-Tuple *...n ~> a -> Boolean', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to compare the values of two ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' instances by value.');
        ie_open('code');
          itext('equals');
        ie_close('code');
        itext(' takes any given argument and will return a ');
        ie_open('code');
          itext('true');
        ie_close('code');
        itext(' if passed an ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' of the same size with match values in the same positions as the ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' ');
        ie_open('code');
          itext('equals');
        ie_close('code');
        itext(' was run on. If the provided argument is not an ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' of the same type or the underlying values are not equal, then ');
        ie_open('code');
          itext('equals');
        ie_close('code');
        itext(' will return ');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Semigroup s1 => 1-Tuple s1 ~> 1-Tuple s1 -> 1-Tuple s1\nSemigroup s1, s2 => 2-Tuple s1 s2 ~> 2-Tuple s1 s2 -> 2-Tuple s1 s2\n...', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Two instances of the same ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' can be combined using concatenation, as long as both have instances of the same ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext('s in the same position. ');
        ie_open('code');
          itext('concat');
        ie_close('code');
        itext(' will be called on each contained ');
        ie_open('code');
          itext('Semigroup');
        ie_close('code');
        itext(' instance with the instance corresponding to the other ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' instance. The result of each concatenation will be provided in a new ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' instance.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\nimport Sum from \'crocks/Sum\'\n\n// Triple :: 3-Tuple\nconst Triple =\n  Tuple(3)\n\n// Unary :: 1-Tuple\nconst Unary =\n  Tuple(1)\n\nTriple([ 1, 3 ], Sum(10), Sum(1))\n  .concat(Triple([ 4 ], Sum.empty(), Sum(9)))\n//=> 3-Tuple( [ 1, 3, 4 ], Sum 10, Sum, 10 )\n\nUnary([ 10 ])\n  .concat(Unary([ 10 ]))\n//=> 1-Tuple( [ 10, 10 ] )', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'map',
            'href', '#map');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: '1-Tuple a ~> (a -> b) -> 1-Tuple b\n2-Tuple a b ~> (b -> c) -> 2-Tuple a c\n...', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to lift a single function into a given ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' to map the rightmost value. ');
        ie_open('code');
          itext('map');
        ie_close('code');
        itext(' takes a function ');
        ie_open('code');
          itext('(a -> b)');
        ie_close('code');
        itext(' and will return a new ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' instance with the result of mapping the rightmost value from its original ');
        ie_open('code');
          itext('a');
        ie_close('code');
        itext(' type to the resulting ');
        ie_open('code');
          itext('b');
        ie_close('code');
        itext('.');
      ie_close('p');
      ie_open('p');
        itext('This method will only apply to the rightmost value. ');
        ie_open('a', null, null,
            'href', '#mapall');
          ie_open('code');
            itext('mapAll');
          ie_close('code');
        ie_close('a');
        itext(' can be used to map over all values in a given ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\n\nimport Maybe from \'crocks/Maybe\'\nimport chain from \'crocks/pointfree/chain\'\nimport getProp from \'crocks/Maybe/getProp\'\n\nconst { Just } = Maybe\n\n// Pair :: 2-Tuple\nconst Pair =\n  Tuple(2)\n\nPair(false, Just({ a: \'this is a\' }))\n  .map(chain(getProp(\'a\')))\n//=> 2-Tuple( false, Just "this is a" )', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'mapall',
            'href', '#mapall');
      ...
      ie_open('p');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' allows for the rightmost portion of a given ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' to be mapped, ');
        ie_open('code');
          itext('mapAll');
        ie_close('code');
        itext(' provides a means to map all values at once, independently of each other. A ');
        ie_open('code');
          itext('Tuple');
        ie_close('code');
        itext(' of ');
        ...
        ie_open('code');
          itext('n');
        ie_close('code');
        itext(' number of functions in the same left to right order as their respective values. ');
        ie_open('code');
          itext('mapAll');
        ie_close('code');
        itext(' returns a new ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' of the same size containing the results of the provided mapping functions.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\nimport objOf from \'crocks/helpers/objOf\'\n\n// Triple :: 3-Tuple\nconst Triple =\n  Tuple(3)\n\n// toUpper :: String -> String\nconst toUpper =\n  x => x.toUpperCase()\n\n// negate :: a -> Boolean\nconst negate =\n  x => !x\n\nTriple(\'little\', false, 94)\n  .mapAll(toUpper, negate, objOf(\'a\'))\n//=> 3-Tuple( "LITTLE", true, { a: 94 } )', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'project',
            'href', '#project');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: '1-Tuple a ~> Integer -> a\n2-Tuple a b ~> Integer -> (a | b)\n3-tuple a b c ~> Integer -> (a | b | c)\n...', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to extract a specific value from a given ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext('. ');
        ie_open('code');
          itext('project');
        ie_close('code');
        itext(' takes a positive, non-zero ');
        ie_open('code');
          itext('Integer');
        ie_close('code');
        itext(' as its input and will return the extracted value residing in the provided 1 based index.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\n\n// Pair :: 2-Tuple\nconst Pair =\n  Tuple(2)\n\n// Triple :: 3-Tuple\nconst Triple =\n  Tuple(3)\n\nTriple(\'one\', \'two\', \'three\')\n  .project(1)\n//=> "one"\n\nPair(\'one\', \'two\')\n  .project(2)\n//=> "two"', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'merge',
            'href', '#merge');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: '1-Tuple a ~> (a -> b) -> b\n2-Tuple a b ~> ((a, b) -> c) -> c\n3-Tuple a b c ~> ((a, b, c) -> d) -> d\n...', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Used to fold a given ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' into a single value, ');
        ie_open('code');
          itext('merge');
        ie_close('code');
        itext(' accepts a function of any arity and will apply each value in the ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(', in order, to the provided function. ');
        ie_open('code');
          itext('merge');
        ie_close('code');
        itext(' returns the result of the application.');
      ie_close('p');
      ie_open('p');
        itext('When using an ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' to manage parallel processing, ');
        ie_open('code');
          itext('merge');
        ie_close('code');
        itext(' is used to combine the separate branches into a single result.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\nimport curry from \'crocks/helpers/curry\'\n\n// Triple :: 3-Tuple\nconst Triple =\n  Tuple(3)\n\n// buildObj :: (a, b, c) -> Object\nconst buildObj = curry(\n  (first, second, third) =>\n    ({ first, second, third })\n)\n\nTriple(99, \'name\', [ 1, 5, 7 ])\n  .merge(buildObj)\n//=> { first: 99, second: "name", third: [ 1, 5, 7 ] }', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'toarray',
            'href', '#toarray');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: '1-Tuple a ~> () -> [ a ]\n2-Tuple a b ~> () -> [ a + b ]\n3-Tuple a b c ~> () -> [ a + b + c ]\n...', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('toArray');
        ie_close('code');
        itext(' is a Natural Transformation from a given ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' to a JavaScript ');
        ie_open('code');
          itext('Array');
        ie_close('code');
        itext('. Any arguments applied to ');
        ie_open('code');
          itext('toArray');
        ie_close('code');
        itext(' will be ignored and will return an Array of ');
        ie_open('code');
          itext('n');
        ie_close('code');
        itext(' size, where ');
        ie_open('code');
          itext('n');
        ie_close('code');
        itext(' corresponds to the size of the ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext('. Each value will be in the same left to right position as the order defined by the ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\n\n// Pair :: 2-Tuple\nconst Pair =\n  Tuple(2)\n\n// Quad :: 4-Tuple\nconst Quad =\n  Tuple(4)\n\nPair(false, { a: false })\n  .toArray()\n//=> [ false, { a: false } ]\n\nQuad([ 1, 3 ], [ 2, 4 ], \'name\', \'Joe\')\n  .toArray()\n//=> [ [ 1, 3 ], [ 2, 4 ], "name", "Joe" ]', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'topic-pointfree');
      ie_open('h2');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Tuple/nmap');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'nmap :: Integer -> ...(* -> *) -> m ...* -> m ...*', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('nmap');
        ie_close('code');
        itext(' takes a non-zero, positive ');
        ie_open('code');
          itext('Integer');
        ie_close('code');
        itext(' as its argument and will return another function that takes the same number of unary functions as the provided ');
        ie_open('code');
          itext('Integer');
        ie_close('code');
        itext('. After all functions are provided, the last argument needs to be an ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext(' of the same size as the provided ');
        ie_open('code');
          itext('Integer');
        ie_close('code');
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Tuple from \'crocks/Tuple\'\nimport nmap from \'crocks/Tuple/nmap\'\n\n// toUpper :: String -> String\nconst toUpper =\n  x => x.toUpperCase()\n\n// add :: Number -> Number -> Number\nconst add =\n  x => y => x + y\n\n// Pair :: 2-Tuple a b\nconst Pair =\n  Tuple(2)\n\n// Triple :: 3-Tuple a b c\nconst Triple =\n  Tuple(3)\n\n// bimap :: (a -> c) -> (b -> d) -> Pair a b -> Pair c d\nconst bimap =\n  nmap(2)\n\n// trimap :: (a -> d) -> (b -> e) -> (c -> f) -> Triple a b c -> Triple d e f\nconst trimap =\n  nmap(3)\n\n// pair :: Pair String Number\nconst pair =\n  Pair(\'jordan\', 13)\n\nbimap(toUpper, add(10), pair)\n//=> 2-Tuple( "JORDAN", 23 )\n\nconst triple =\n  Triple(32, \'string\', 0)\n\ntrimap(add(10), toUpper, add(10), triple)\n//=> 3-Tuple( 42, "STRING", 10 )', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('a', null, null,
            'id', 'project',
            'href', '#project');
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Tuple/project');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'project :: Integer -> m ...* -> a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('project');
        ie_close('code');
        itext(' takes a positive, non-zero Integer as its input and returns another function that accepts an ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext('. It then returns the value from the ');
        ie_open('code');
          itext('n-Tuple');
        ie_close('code');
        itext('that resides at the provided ');
        ie_open('code');
          itext('Integer');
        ie_close('code');
        itext(' index.');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('crocks/Tuple/tupleToArray');
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'tupleToArray :: Tuple a -> [ a ]\ntupleToArray :: (a -> Tuple b) -> a -> [ b ]', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2388}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'uQBsp.render';
}
...
class uQBsp extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(uQBsp, templates);
...
var _TupleSoy = __webpack_require__(230);

var _TupleSoy2 = _interopRequireDefault(_TupleSoy);
...
var uQBsp = function (_Component) {
  _inherits(uQBsp, _Component);

  function uQBsp() {
    _classCallCheck(this, uQBsp);

    return _possibleConstructorReturn(this, (uQBsp.__proto__ || Object.getPrototypeOf(uQBsp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uQBsp, _TupleSoy2.default);

exports.default = uQBsp;
