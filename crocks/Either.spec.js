...
test('Either ap errors', t => {
  ...
  t.throws(Either.of(unit).ap.bind(null, undefined), TypeError, 'throws when passed an undefined')
  t.throws(Either.of(unit).ap.bind(null, null), TypeError, 'throws when passed a null')
  t.throws(Either.of(unit).ap.bind(null, 0), TypeError, 'throws when passed a falsey number')
  t.throws(Either.of(unit).ap.bind(null, 1), TypeError, 'throws when passed a truthy number')
  t.throws(Either.of(unit).ap.bind(null, ''), TypeError, 'throws when passed a falsey string')
  t.throws(Either.of(unit).ap.bind(null, 'string'), TypeError, 'throws when passed a truthy string')
  t.throws(Either.of(unit).ap.bind(null, false), TypeError, 'throws when passed false')
  t.throws(Either.of(unit).ap.bind(null, true), TypeError, 'throws when passed true')
  t.throws(Either.of(unit).ap.bind(null, []), TypeError, 'throws when passed an array')
  t.throws(Either.of(unit).ap.bind(null, {}), TypeError, 'throws when passed an object')

  t.doesNotThrow(Either.Left(unit).ap.bind(null, Either.of(0)), 'does not throw when ap on Left')

  t.throws(Either.of(unit).ap.bind(null, m), TypeError, 'throws when container types differ on Right')
...
test('Either chain errors', t => {
  ...
  t.throws(rchain(unit), TypeError, 'Right throws with a non Either returning function')
...
test('Either sequence errors', t => {
  ...
  t.throws(rseqBad(unit), TypeError, 'Right without wrapping Applicative throws')
...
test('Either traverse errors', t => {
  ...
  t.throws(rtrav(undefined, unit), TypeError, 'Right throws with undefined in first argument')
  t.throws(rtrav(null, unit), TypeError, 'Right throws with null in first argument')
  t.throws(rtrav(0, unit), TypeError, 'Right throws falsey with number in first argument')
  t.throws(rtrav(1, unit), TypeError, 'Right throws truthy with number in first argument')
  t.throws(rtrav('', unit), TypeError, 'Right throws falsey with string in first argument')
  t.throws(rtrav('string', unit), TypeError, 'Right throws with truthy string in first argument')
  t.throws(rtrav(false, unit), TypeError, 'Right throws with false in first argument')
  t.throws(rtrav(true, unit), TypeError, 'Right throws with true in first argument')
  t.throws(rtrav([], unit), TypeError, 'Right throws with an array in first argument')
  t.throws(rtrav({}, unit), TypeError, 'Right throws with an object in first argument')
  ...
  t.throws(rtrav(unit, unit), TypeError, 'Right throws when first function does not return an Applicaitve')
  ...
  t.throws(ltrav(unit, undefined), TypeError, 'Left throws with undefined in second argument')
  t.throws(ltrav(unit, null), TypeError, 'Left throws with null in second argument')
  t.throws(ltrav(unit, 0), TypeError, 'Left throws falsey with number in second argument')
  t.throws(ltrav(unit, 1), TypeError, 'Left throws truthy with number in second argument')
  t.throws(ltrav(unit, ''), TypeError, 'Left throws falsey with string in second argument')
  t.throws(ltrav(unit, 'string'), TypeError, 'Left throws with truthy string in second argument')
  t.throws(ltrav(unit, false), TypeError, 'Left throws with false in second argument')
  t.throws(ltrav(unit, true), TypeError, 'Left throws with true in second argument')
  t.throws(ltrav(unit, []), TypeError, 'Left throws with an array in second argument')
  t.throws(ltrav(unit, {}), TypeError, 'Left throws with an object in second argument')
  t.throws(ltrav(unit, unit), TypeError, 'Left throws when second function does not return an Applicaitve')
