...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BHPaL", function() { return BHPaL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace BHPaL.
 * @public
 */

goog.module('BHPaL.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3174 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Assign :: Object -> Assign Object', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('Assign');
        ie_close('code');
        itext(' is constructed by calling the constructor with an ');
        ie_open('code');
          itext('Object');
        ie_close('code');
        itext(' instance. This will return a new ');
        ie_open('code');
          itext('Assign');
        ie_close('code');
        itext(' instance, wrapping the reference to the provided ');
        ie_open('code');
          itext('Object');
        ie_close('code');
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Assign from \'crocks/Assign\'\n\nAssign({ a: 123, b: false })\n//=> Assign({ a: 123, b: false })', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3174}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'BHPaL.render';
}
...
class BHPaL extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(BHPaL, templates);
...
var _AssignSoy = __webpack_require__(243);
...
var BHPaL = function (_Component) {
  _inherits(BHPaL, _Component);

  function BHPaL() {
    _classCallCheck(this, BHPaL);

    return _possibleConstructorReturn(this, (BHPaL.__proto__ || Object.getPrototypeOf(BHPaL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BHPaL, _AssignSoy2.default);

exports.default = BHPaL;
