var pageComponent =
webpackJsonppageComponent([0,21,22,23],[
/* 0 */
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('Because Functional Programming matters and Crocks make that world simplier curating and providing not only a common interface between each type (where possible of course), but also all of the helper functions needed to hit the ground running.');
          ie_close('p');
        ie_close('div');
      ie_close('div');
    ie_close('div');
    ...
    ie_open('div', null, null,
      ...
      ie_open('section', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('Crocks implements all Functor based Data Types that provide different computational contexts for working in a more declarative, functional flow');
          ie_close('p');
        ie_close('div');
        ie_open('div', null, null,
      ...
      ie_open('section', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('You have heard of things like Maybe and Either and heck maybe even IO, that is what Crocks provide.');
          ie_close('p');
        ie_close('div');
        ie_open('div', null, null,
      ...
      ie_open('section', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('Crocks provides Monoid, where you can represent a binary operation and usually locked down it to a specific type. These are great when you need to combine a list of values down to one value.');
          ie_close('p');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-md-5 col-md-offset-1');
