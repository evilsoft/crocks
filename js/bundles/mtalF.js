...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mtalF", function() { return mtalF; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace mtalF.
 * @public
 */

goog.module('mtalF.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3428 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('Monoid');
      ie_close('code');
      itext(' that will always return the last, non-empty value when two ');
      ie_open('code');
        itext('Last');
      ie_close('code');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Last :: a -> Last (Maybe a)\nLast :: Maybe a -> Last (Maybe a)', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('A ');
        ie_open('code');
          itext('Last');
      ...
      ie_open('p');
        ...
        itext('.');
      ie_close('p');
      $templateAlias2({code: 'import Last from \'crocks/Last\'\nimport Maybe from \'crocks/Maybe\'\n\nconst { Just, Nothing } = Maybe\n\nLast(Just([ 1, 2, 3 ]))\n//=> Last( Just [ 1, 2, 3 ] )\n\nLast(Nothing())\n//=> Last( Nothing )\n\nLast(null)\n//=> Last( Just null )\n\nLast(false)\n//=> Last( Just false )', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Last a ~> b -> Boolean', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3428}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'mtalF.render';
}
...
class mtalF extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(mtalF, templates);
...
var _LastSoy = __webpack_require__(246);
...
var mtalF = function (_Component) {
  _inherits(mtalF, _Component);

  function mtalF() {
    _classCallCheck(this, mtalF);

    return _possibleConstructorReturn(this, (mtalF.__proto__ || Object.getPrototypeOf(mtalF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mtalF, _LastSoy2.default);

exports.default = mtalF;
