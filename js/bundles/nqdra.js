...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nqdra", function() { return nqdra; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace nqdra.
 * @public
 */

goog.module('nqdra.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3242 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Endo :: (a -> a) -> Endo a', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('Endo');
        ie_close('code');
        itext(' is constructed by passing the constructor an Endomorphism, which is a function in which the domain/codomain (src/target) are of the same type. For example a function that is ');
        ie_open('code');
          itext('String -> String');
        ie_close('code');
        itext('.');
      ie_close('p');
      ie_open('p');
        itext('There is no type checking on the provided function, so some discipline on the part of the user is required to make sure the proper type is being used on in all cases. This can be partly mitigated by using an Endomorphism of the type ');
        ie_open('code');
          itext('Maybe a');
        ie_close('code');
        itext('. Then the supplied functions could do type checking and return ');
        ie_open('code');
          itext('Nothing');
        ie_close('code');
        itext(' if the types do not match up.');
      ie_close('p');
      $templateAlias2({code: 'import Endo from \'crocks/Endo\'\n\nEndo(x => x + 5)\n//=> Endo (Number -> Number)', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3242}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'nqdra.render';
}
...
class nqdra extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(nqdra, templates);
...
var _EndoSoy = __webpack_require__(244);
...
var nqdra = function (_Component) {
  _inherits(nqdra, _Component);

  function nqdra() {
    _classCallCheck(this, nqdra);

    return _possibleConstructorReturn(this, (nqdra.__proto__ || Object.getPrototypeOf(nqdra)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nqdra, _EndoSoy2.default);

exports.default = nqdra;
