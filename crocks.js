...
const transforms = {
  ...
  eitherToFirst: require('./transforms/eitherToFirst'),
  ...
  firstToAsync: require('./transforms/firstToAsync'),
  firstToEither: require('./transforms/firstToEither'),
  firstToLast: require('./transforms/firstToLast'),
  firstToMaybe: require('./transforms/firstToMaybe'),
  firstToResult: require('./transforms/firstToResult'),
  lastToAsync: require('./transforms/lastToAsync'),
  lastToEither: require('./transforms/lastToEither'),
  lastToFirst: require('./transforms/lastToFirst'),
  ...
  maybeToFirst: require('./transforms/maybeToFirst'),
  ...
  resultToFirst: require('./transforms/resultToFirst'),
