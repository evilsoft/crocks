...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "jHTQj", function() { return jHTQj; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace jHTQj.
 * @public
 */

goog.module('jHTQj.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param311 = function() {
    ...
    ie_open('p');
      ...
      ie_close('code');
      itext('if the underlying data running through the ');
      ie_open('code');
        itext('Arrow');
      ie_close('code');
      itext(' is a ');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Arrow :: (a -> b) -> Arrow a b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('An ');
        ie_open('code');
          itext('Arrow');
        ie_close('code');
        itext(' is constructed with a unary function of type ');
        ie_open('code');
          itext('(a -> b)');
        ie_close('code');
        itext('. The input, or domain, of the function is the left parameter in the type signature and the output, or co-domain, of the function represents the right.');
      ie_close('p');
      $templateAlias2({code: 'import Arrow from \'crocks/Arrow\'\n\nimport compose from \'crocks/helpers/compose\'\nimport getProp from \'crocks/Maybe/getProp\'\nimport option from \'crocks/pointfree/option\'\n\n// length :: a -> Integer\nconst length = compose(\n  option(0),\n  getProp(\'length\')\n)\n\n// Arrow a Integer\nArrow(length)\n//=> Arrow (a -> Integer)', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('code');
          itext('compose');
        ie_close('code');
        itext(' allows you to compose two ');
        ie_open('code');
          itext('Arrow');
        ie_close('code');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'jHTQj.render';
}
...
class jHTQj extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(jHTQj, templates);
...
var jHTQj = function (_Component) {
  _inherits(jHTQj, _Component);

  function jHTQj() {
    _classCallCheck(this, jHTQj);

    return _possibleConstructorReturn(this, (jHTQj.__proto__ || Object.getPrototypeOf(jHTQj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jHTQj, _ArrowSoy2.default);

exports.default = jHTQj;
