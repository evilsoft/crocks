...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eRPXO", function() { return eRPXO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace eRPXO.
 * @public
 */

goog.module('eRPXO.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' or the contained values are not equal by value then ');
        ie_open('code');
          itext('equals');
        ie_close('code');
        itext(' will return ');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Result');
        ie_close('code');
        itext(' regardless of whether it\'s an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Result c a ~> ((c -> Result d b), (a -> Result d b)) -> Result d b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Combining a sequential series of transformations that capture disjunction can be accomplished with ');
        ie_open('a', null, null,
            'href', '#chain');
          ...
          ie_close('code');
        ie_close('a');
        itext('. Along the same lines, ');
        ie_open('code');
          itext('bichain');
        ie_close('code');
        itext(' allows you to do this from both ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('code');
          itext('bichain');
        ie_close('code');
        itext(' expects two unary, ');
        ie_open('code');
          itext('Either');
        ie_close('code');
        itext(' returning functions as its arguments. When invoked on an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('code');
          itext('bichain');
        ie_close('code');
        itext(' will use the left, or first, function that can return either an ');
        ie_open('a', null, null,
            'href', '#err');
          ie_open('code');
            itext('Err');
        ...
        ie_open('a', null, null,
          ...
          ie_close('code');
        ie_close('a');
        itext(' instance. When called on an ');
        ie_open('a', null, null,
            'href', '#ok');
          ie_open('code');
            itext('Ok');
          ie_close('code');
        ie_close('a');
        itext(' instance, it will behave exactly as ');
        ie_open('a', null, null,
            'href', '#chain');
          ie_open('code');
            itext('chain');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('tryCatch');
        ie_close('code');
        itext('. You can wrap this function and it will always return a ');
        ie_open('code');
          itext('Result');
        ie_close('code');
      ie_close('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param2550}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'eRPXO.render';
}
...
class eRPXO extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(eRPXO, templates);
...
var eRPXO = function (_Component) {
  _inherits(eRPXO, _Component);

  function eRPXO() {
    _classCallCheck(this, eRPXO);

    return _possibleConstructorReturn(this, (eRPXO.__proto__ || Object.getPrototypeOf(eRPXO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eRPXO, _ResultSoy2.default);

exports.default = eRPXO;
