var pageComponent =
webpackJsonppageComponent([12,21,22,23],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TJchX", function() { return TJchX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace TJchX.
 * @public
 */

goog.module('TJchX.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param943 = function() {
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'mconcat :: Monoid m => m -> ([ a ] | List a) -> m a', mode: 'haskell'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'mreduce',
          'href', '#mreduce');
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'mreduce :: Monoid m => m -> ([ a ] | List a) -> a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'mconcatMap :: Monoid m => m -> (b -> a) -> ([ b ] | List b) -> m a', mode: 'haskell'}, null, opt_ijData);
    ie_open('h4');
      ie_open('a', null, null,
          'id', 'mreducemap',
          'href', '#mreducemap');
    ...
    ie_open('p');
      ...
      ie_close('code');
    ie_close('p');
    $templateAlias2({code: 'mreduceMap :: Monoid m => m -> (b -> a) -> ([ b ] | List b) -> a', mode: 'haskell'}, null, opt_ijData);
    ie_open('p');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'TJchX.render';
}
...
class TJchX extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(TJchX, templates);
...
var _helpersSoy = __webpack_require__(225);
...
var TJchX = function (_Component) {
  _inherits(TJchX, _Component);

  function TJchX() {
    _classCallCheck(this, TJchX);

    return _possibleConstructorReturn(this, (TJchX.__proto__ || Object.getPrototypeOf(TJchX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TJchX, _helpersSoy2.default);

exports.default = TJchX;
