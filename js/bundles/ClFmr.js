...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClFmr", function() { return ClFmr; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace ClFmr.
 * @public
 */

goog.module('ClFmr.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param3682 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ...
        ie_close('a');
      ie_close('h2');
      $templateAlias2({code: 'Prod :: Number -> Prod Number', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        ie_open('code');
          itext('Prod');
        ie_close('code');
        itext(' provides multiplication on ');
        ie_open('code');
          itext('Number');
        ie_close('code');
        itext('s and needs to be constructed with a ');
        ie_open('code');
          itext('Number');
        ie_close('code');
        itext(' instance. Calling the constructor with a ');
        ie_open('code');
          itext('Number');
        ie_close('code');
        itext(', results in a new');
        ie_open('code');
          itext('Prod');
        ie_close('code');
        itext(' that wraps the provided ');
        ie_open('code');
          itext('Number');
        ie_close('code');
        itext('.');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('null');
        ie_close('code');
        itext(' to the constructor will result in an');
        ie_open('code');
          itext('empty');
        ie_close('code');
        itext(' instance, or an instance containing a ');
        ie_open('code');
          itext('1');
        ie_close('code');
        itext('.');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param3682}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'ClFmr.render';
}
...
class ClFmr extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(ClFmr, templates);
...
var _ProdSoy = __webpack_require__(249);
...
var ClFmr = function (_Component) {
  _inherits(ClFmr, _Component);

  function ClFmr() {
    _classCallCheck(this, ClFmr);

    return _possibleConstructorReturn(this, (ClFmr.__proto__ || Object.getPrototypeOf(ClFmr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ClFmr, _ProdSoy2.default);

exports.default = ClFmr;
