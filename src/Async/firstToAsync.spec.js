...
test('firstToAsync transform', t => {
  ...
  const err = /firstToAsync: Second argument must be a First or a Function that returns a First/
...
test('firstToAsync with First returning function', t => {
  ...
  const err = /firstToAsync: Second argument must be a Function that returns a First/
