...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RxtQx", function() { return RxtQx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace RxtQx.
 * @public
 */

goog.module('RxtQx.incrementaldom');
  ...
  var param1755 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h4');
        ...
        ie_close('a');
      ie_close('h4');
      $templateAlias2({code: 'Maybe a ~> ((() -> Maybe b), (a -> Maybe b)) -> Maybe b', mode: 'haskell'}, null, opt_ijData);
      ie_open('p');
        itext('Combining a sequential series of transformations that capture disjunction can be accomplished with ');
        ie_open('a', null, null,
            'href', '#chain');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'RxtQx.render';
}
...
class RxtQx extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(RxtQx, templates);
...
var RxtQx = function (_Component) {
  _inherits(RxtQx, _Component);

  function RxtQx() {
    _classCallCheck(this, RxtQx);

    return _possibleConstructorReturn(this, (RxtQx.__proto__ || Object.getPrototypeOf(RxtQx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RxtQx, _MaybeSoy2.default);

exports.default = RxtQx;
